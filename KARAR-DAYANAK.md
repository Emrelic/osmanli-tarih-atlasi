...
| 11 | **Engel ölçüsü = TIRMANIŞ** (min-yol üzerindeki max yükseklik − yüksek uç), zirve yüksekliği değil (kullanıcı kararı) | **engel eşiği — MİNİMAX** (m) | **50 m zayıf · 200 m güçlü** (25-75 km: %45→%71→%86) kapsam %71'de DEĞİŞMEDİ · 30″ max havuzlama = ÜST SINIR | COĞRAFYA |
...
| 14 | **Sudan öbeğinde `1899-01-19` KALIYOR** — kaynaklı üç kayıt (Darfur `1898-09-02`) geri çekilmiyor; tutarsızlık KASITLI | **`1899-01-19` taşıyan kayıt** sayısı (hukukî tarih, fiilî değil) | 18 · kaynaklı olan 3 ayrı günde | ARABİSTAN · KOORDİNATÖR |
...
| 13 | **`scalerank ≤ 7` İPTAL** — nehirler TÜRDEŞ DEĞİL; küratlı `BUYUK` listesi kalıyor, ad eşleştirmesi onarılacak | **nehir bazında ayrışma oranı** (25-75 km, minimax) | **Tuna %94-100 (n=31) ↔ Nil %22 (n=52)** · Fırat %57 · Volga %17 — ilk bulgu iki zıt popülasyonun ortalamasıymış | COĞRAFYA · MOTOR |
