...
{ t:"1452-01-01", k:"kurulus", etiket:["askeri"], b:"Kilitbahir Kalesi'nin inşası — Çanakkale Boğazı'nın kontrolü", gun:"1452", yer:"Kilitbahir, Çanakkale Boğazı", yer_id:"Kilitbahir", kisiler:"II. Mehmed (Fâtih)",
  d:"II. Mehmed, henüz İstanbul'u almadan önce Çanakkale Boğazı'nı denetim altına almak için Rumeli yakasında Kilitbahir Kalesi'ni inşa ettirdi; karşı (Anadolu) yakadaki Kal'a-i Sultâniyye ile birlikte boğazı çapraz ateşe alan bir çift oluşturdu. Kale, Kanûnî döneminde (948/1541) bir kule eklenerek genişletildi.", ic_not_d:"TDV'nin `kilitbahir-kalesi` maddesi Evliya Çelebi'ye dayanarak inşayı 856 (1452) yılına tarihler, Kritovulos ise Gelibolu-Bolayır sancak beyi Yâkub Bey'in nezaretinde işin 869'da (1464-65) tamamlandığını yazar — iki rivayet arasındaki fark madde metninde açıkça belirtilir.",
