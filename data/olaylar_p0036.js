...
{ t:"1452-01-01", k:"kurulus", etiket:["askeri"], b:"Kilitbahir Kalesi'nin inşası — Çanakkale Boğazı'nın kontrolü", gun:"1452", yer:"Kilitbahir, Çanakkale Boğazı", yer_id:"Kilitbahir", kisiler:"II. Mehmed (Fâtih)",
  d:"II. Mehmed, henüz İstanbul'u almadan önce Çanakkale Boğazı'nı denetim altına almak için Rumeli yakasında Kilitbahir Kalesi'ni inşa ettirdi; karşı (Anadolu) yakadaki Kal'a-i Sultâniyye ile birlikte boğazı çapraz ateşe alan bir çift oluşturdu. TDV'nin", ic_not_d:"`kilitbahir-kalesi` maddesi Evliya Çelebi'ye dayanarak inşayı 856 (1452) yılına tarihler, Kritovulos ise Gelibolu-Bolayır sancak beyi Yâkub Bey'in nezaretinde işin 869'da (1464-65) tamamlandığını yazar — iki rivayet arasındaki fark madde metninde açıkça belirtilir. Kale, Kanûnî döneminde (948/1541) bir kule eklenerek genişletildi.",
...
{ t:"1913-07-29", k:"antlasma", etiket:["toprak-kayip","siyaset"], b:"Katar'dan Osmanlı feragati — Londra Sözleşmesi", gun:"29 Temmuz 1913", yer:"Londra, Katar (Doha)", yer_id:"Doha (Katar)", kisiler:"Şeyh Kāsım b. Sânî",
  d:"29 Temmuz 1913'te Londra'da imzalanan İngiliz-Osmanlı sözleşmesiyle Osmanlı Devleti, Katar yarımadası üzerindeki bütün taleplerinden feragat etti; yarımadanın Şeyh Kāsım b. Sânî ve haleflerince yönetilmesi kabul edildi. TDV'nin", ic_not_d:"`katar` maddesine göre sözleşme resmen yürürlüğe girmedi ama fiilî durumu tescil etti — Osmanlı garnizonunun bölgeden tam çekilişi I. Dünya Savaşı ile tamamlandı. Doha (Bida) kaydında bu tarih zaten bir `v:` döneminin bitişi olarak duruyordu; bu madde o kırılmanın kaynağını taşır.",
  kaynak:"katar", duygu:["😔"] }
