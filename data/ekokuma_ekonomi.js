...
{ id:"1585-tagsis-fiyat-devrimi", tur:"sebep-sonuc",
  ...
  bag:"TDV'nin Akçe maddesi 1584-86 arası ayar değişikliklerini (yüz dirhemden 800 akçe basılmaya başlanması) doğruluyor, ama tağşişin 'Amerikan gümüşü' tetikleyicisini kendisi açıkça yazmıyor — bu bağlantı Osmanlı iktisat tarihindeki yaygın 'fiyat devrimi' yorumuna dayanır. 1589'daki Beylerbeyi Vak'ası ise TDV'nin Abdülkadir Şeyhî Efendi maddesiyle doğrudan bağlanıyor: tağşiş edilmiş akçeyle ödeme yapılması üzerine sipahi ve yeniçeriler sarayı kuşattı, şeyhülislam bu yüzden azledildi.", ic_not_bag:"eski: bu satır atlasın 1585-01-01 kaydının kendi metnine (…) ve … 'fiyat devrimi' yorumuna dayanıyor, ikinci bağımsız bir TDV sayfasıyla ayrıca doğrulanmadı.",
...
{ id:"kapitulasyon-diplomatik-araçtan-mali-bagimliliga", tur:"sebep-sonuc",
  ...
  bag:"Kronolojinin 18 Şubat 1536 kaydı bu dönüşümü tek cümlede özetler: 'o gün diplomatik araç olan kapitülasyonlar, yüzyıllar içinde mali bağımlılığın kapısına dönüşecekti.' TDV'nin Ahidnâme maddesi ara halkayı doğruluyor: Fransa'dan (1536) sonra İngiltere (1580) ve Hollanda (1612) benzer imtiyazlar aldı; 18. yüzyılda birden çok Avrupa devleti 'en çok kayrılan millet' statüsüne ulaştı, ve gümrük resmini ilk %3'e indirmeyi başaran İngilizlerin ardından %5 ödeyen ötekiler de İngiliz bayrağı altında ticaret yapmaya başladı — yani kapitülasyonlar arasında REKABETÇİ bir aşağı çekme dinamiği vardı. 30 Mayıs 1740 kaydı ise dönüm noktasını taşır: imtiyazlar artık tek bir padişahla sınırlı olmaktan çıkıp kalıcı antlaşmaya bağlandı, 'tek taraflı feshedilemez hâle gelen kapitülasyon rejimi ancak Lozan'da kaldırılabildi' — 1914'teki kaldırma bile SAVAŞ KOŞULLARINDA, tek taraflı bir ilandı ve hukuken ancak 1923 Lozan'da kalıcı hâle geldi.", ic_not_bag:"eski ifadeler: «Atlasın kendi 1536-02-18 kaydı (kaynak: fransa) …» · «Atlasın 1740-05-30 kaydı ise …» · «TDV'nin kapitülasyon maddesinin kendisi kısa bir tanım sayfası ve bu geniş tarihsel çerçeveyi ayrıca doğrulamadı; zincirin dayanağı bu yüzden atlasın kendi 1536/1740/1914 kayıtlarına ve `ahidname` maddesine dayanıyor.»",
