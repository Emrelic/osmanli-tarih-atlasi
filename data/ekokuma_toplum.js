...
{ id:"timar-avrupa-feodalizm-farki", tur:"tartisma",
  ...
  bag:"Bu karşılaştırma Emre'nin sorduğu soruyu (Osmanlı ekonomik yapısının Avrupa feodalizmi, sanayi devrimi, aydınlanma, kilise-kral-soylular düzeniyle farkı) yalnız TEK bir eksende — toprak/asker ilişkisinde — cevaplıyor. Kilise-devlet ayrımı, burjuvazi ve sanayi devrimi eksenleri bu turda İŞLENMEDİ (denetim/EKO-TOPLUM-0916.md'de not edildi).",
  kesinlik:"tartismali",
  olay:["1827-02-01"],
  kaynak:"TDV: timar" },
...
{ id:"sehzade-mehmed-sunnet-dugunu-1582", tur:"sebep-sonuc",
  ...
  metin:"Şenlik sırasında esnaf teşkilatları (bkz. 'lonca-esnaf-teskilati' kartı) alaylar düzenleyip kendi meslek gösterilerini sergiledi — bu, hem bir eğlence hem de esnafın devlete sadakatini gösterme fırsatıydı. Doğum ve ölüm törenleri bu turda AYRICA araştırılmadı; yalnız bu tek, iyi belgelenmiş vaka işlendi.",
  kesinlik:"kesin",
  zincir:[],
  olay:["1582-05-29"],
...
{ id:"feshane-osmanli-sanayilesme-girisimi", tur:"sebep-sonuc",
  ...
  metin:"Fabrika 1925'te şapka kanunuyla fes üretiminin yasaklanmasına kadar faaliyetini sürdürdü. Osmanlı'nın bu tekil başarı öyküsü, H-0033 kartındaki (tımar/Avrupa feodalizmi) yapısal soruyla birlikte okunmalı: neden bu tür girişimler tek tek devlet fabrikaları olarak kaldı, İngiltere'deki gibi özel sermayeli bir sanayi devrimine dönüşmedi — bu soru bu turda ayrıca İŞLENMEDİ.",
  kesinlik:"kesin",
...
{ id:"lonca-esnaf-teskilati", tur:"sebep-sonuc",
  ...
  metin:"'Lonca' kelimesinin kendisi İtalyanca 'loggia'dan gelir — Osmanlı ile İtalyan şehir devletleri arasındaki ticarî temasın bir izidir. Gedik sistemi, esnafı hem korudu (tekel garantisi) hem de dondurdu: yeni girişimciliği ve rekabeti sınırlayarak, TDV'nin doğrudan belirtmediği ama H-0033/H-0120 kartlarındaki sanayileşme sorusuyla dolaylı bağlantılı bir yapısal katılığa yol açtı.",
  kesinlik:"kesin",
...
{ id:"hat-sanati-sheyh-hamdullah-hafiz-osman", tur:"sebep-sonuc",
  ...
  bag:"Hattatlık usta-çırak esasıyla aktarıldı; harfler kamış kalemle yazılıp 'nokta' birimiyle ölçülendirildi. Bu geleneğin bir sonraki büyük dönüm noktası (Mustafa Râkım, ö. 1826) — celî sülüsü 'Râkım öncesi/sonrası' diye ikiye ayıran reform — bu turda AYRI bir kart olarak İŞLENMEDİ.",
