...
window.EKOKUMA_CAMITARZ = [
  {
    ...
    not: "Bu kart bir sentezdir; her dönemin somut örnek yapısı ayrı kartlarda (bu dosyada ya da data/ekokuma_mimari.js / ekokuma_mimari2.js dosyalarında) anlatılır: klasik dönem için mimari-uc-serefeli-camii (ekokuma_mimari2.js), mimari-sehzade-camii, mimari-suleymaniye, mimari-selimiye; Osmanlı barok için mimari-nuruosmaniye, mimari-fatih-camii (ekokuma_mimari.js); Lâle Devri bağlamı için mimari-sadabad (ekokuma_mimari2.js); erken Osmanlı ve ampir/eklektik için bu dosyadaki camitarz-bursa-ulucami ve camitarz-nusretiye-camii kartları.",
    kesinlik: "kesin",
    olay: [],
  ...
  },
  {
    ...
    not: "Kart yalnız camiyi anlatır; Dolmabahçe Sarayı (aynı üslup dönemi, ama bir saray) data/ekokuma_mimari.js'teki mimari-dolmabahce-sarayi kartında ayrıca işlenmiştir, burada tekrarlanmadı.",
    kesinlik: "kesin",
    olay: ["1826-06"],
