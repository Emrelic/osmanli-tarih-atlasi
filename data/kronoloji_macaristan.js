...
{ t:"1308-11-27", b:"Károly Róbert'in (I. Károly, Anjou hanedanı) genel kabulle kral ilan edilmesi", tur:"kurulus", onem:5, dunya:2, kapsam:"ic",
...
{ t:"1351-12-11", b:"I. Lajos'un büyük yasası — soylu ayrıcalıklarının genelleştirilmesi ve 'aviticitas'", tur:"kanun", onem:4, dunya:1, kapsam:"ic",
  etiket:["kanun","idari"],
...
{ t:"1367-01-01", b:"Pécs Üniversitesi'nin kurulması — Macaristan'ın ilk yükseköğretim kurumu", tur:"kurulus", onem:3, dunya:1, kapsam:"ic",
  etiket:["bilim","egitim"],
  yer_id:"",
...
{ t:"1387-03-31", b:"Luxemburglu Zsigmond'un kral seçilmesi", tur:"hukumdar", onem:4, dunya:2, kapsam:"ic",
  etiket:["hukumdar","hanedan"],
  yer_id:"İstolni Belgrad",
...
{ t:"1408-12-12", b:"Ejderha Nişanı'nın (Societas Draconistarum) kurulması", tur:"kurulus", onem:2, dunya:1, kapsam:"ic",
  etiket:["kultur","kurum"],
  yer_id:"",
...
{ t:"1437-07-06", b:"Bobâlna Köylü Ayaklanması ve Erdel'de Üç Millet İttifakı'nın (Unio Trium Nationum) kurulması", tur:"isyan", onem:4, dunya:1, kapsam:"ic",
...
{ t:"1446-06-05", b:"Hunyadi János'un Macaristan naibi (kormányzó) seçilmesi", tur:"hukumdar", onem:4, dunya:1, kapsam:"ic",
...
{ t:"1456-08-11", b:"Hunyadi János'un veba salgınında ölümü", tur:"olum", onem:5, dunya:2, kapsam:"ic",
...
{ t:"1458-01-24", b:"Hunyadi Mátyás'ın (Mátyás Corvinus) kral seçilmesi", tur:"kurulus", onem:5, dunya:2, kapsam:"ic",
  etiket:["hukumdar","hanedan"],
  yer_id:"Budin",
...
{ t:"1464-03-29", b:"Mátyás'ın Székesfehérvár'da (İstolni Belgrad) taç giymesi", tur:"hukumdar", onem:3, dunya:1, kapsam:"ic",
  etiket:["hukumdar"],
  yer_id:"İstolni Belgrad",
...
{ t:"1465-06-01", b:"Pozsony Üniversitesi'nin (Academia Istropolitana) kurulması", tur:"kurulus", onem:2, dunya:1, kapsam:"ic",
  etiket:["bilim","egitim"],
  yer_id:"Bratislava",
...
{ t:"1467-01-01", b:"Mátyás'ın vergi reformu — 'kapu adı' (hane) vergisinin genelleştirilmesi", tur:"reform", onem:4, dunya:1, kapsam:"ic",
  etiket:["mali","reform"],
  yer_id:"", kapsam_genis:true,
...
{ t:"1476-12-15", b:"Mátyás'ın Nápoli Prensesi Beatrice ile evlenmesi ve saraya İtalyan Rönesansı'nın girişi", tur:"evlilik", onem:3, dunya:2, kapsam:"dis",
  etiket:["kultur","evlilik","diplomasi"],
  yer_id:"Budin",
...
{ t:"1485-06-01", b:"Mátyás'ın Viyana'yı ele geçirmesi", tur:"toprak-kazanc", onem:5, dunya:3, kapsam:"dis",
  etiket:["askeri","toprak-kazanc"],
  yer_id:"Viyana",
...
{ t:"1489-01-01", b:"Bibliotheca Corviniana'nın Avrupa'nın önde gelen Rönesans kütüphanelerinden biri hâline gelmesi", tur:"kultur", onem:4, dunya:2, kapsam:"ic",
  etiket:["kultur","bilim"],
  yer_id:"Budin",
...
{ t:"1490-04-06", b:"Mátyás Corvinus'un ölümü", tur:"olum", onem:5, dunya:3, kapsam:"ic",
  etiket:["hukumdar","hanedan"],
  yer_id:"",
...
{ t:"1490-07-15", b:"II. Ulászló'nun (Jagiellon) kral seçilmesi", tur:"hukumdar", onem:4, dunya:2, kapsam:"ic",
  etiket:["hukumdar","hanedan"],
  yer_id:"İstolni Belgrad",
...
{ t:"1514-05-01", b:"Dózsa György köylü ayaklanmasının başlaması", tur:"isyan", onem:5, dunya:2, kapsam:"ic",
  etiket:["isyan","sosyal"],
  yer_id:"",
...
{ t:"1526-11-10", b:"Szapolyai János'un (I. János) rakip kral seçilmesi", tur:"bolunme", onem:5, dunya:2, kapsam:"ic",
  etiket:["hukumdar","bolunme"],
  yer_id:"İstolni Belgrad",
...
{ t:"1527-01-01", b:"I. Ferdinand'ın da kral seçilmesi — iki kral dönemi", tur:"bolunme", onem:5, dunya:2, kapsam:"dis",
  etiket:["hukumdar","bolunme","hanedan"],
  yer_id:"İstolni Belgrad",
  ...
  kaynak:"akademik: Engel (2001), s. 362-364" },

{ t:"1538-02-24", b:"Nagyvárad Antlaşması — Zápolya-Ferdinand paylaşımı", tur:"antlasma", onem:4, dunya:2, kapsam:"ic",
...
{ t:"1552-09-04", b:"Eğri Kalesi'nin savunması — Dobó István'ın direnişi", tur:"savas", onem:4, dunya:2, kapsam:"dis",
  etiket:["askeri","kusatma"],
  yer_id:"Eğri",
...
{ t:"1566-09-08", b:"Sigetvár Kuşatması ve Kanuni'nin ölümü", tur:"savas", onem:5, dunya:3, kapsam:"dis",
...
{ t:"1604-10-15", b:"Bocskai İstván ayaklanmasının başlaması", tur:"isyan", onem:5, dunya:2, kapsam:"ic",
  etiket:["isyan","din"],
  yer_id:"",
...
{ t:"1606-11-11", b:"Zitvatorok Antlaşması", tur:"antlasma", onem:4, dunya:3, kapsam:"dis",
...
{ t:"1619-08-26", b:"Bethlen Gábor'un Bohemya seferi — Otuz Yıl Savaşları'na katılım", tur:"savas", onem:4, dunya:3, kapsam:"dis",
...
{ t:"1629-11-15", b:"Bethlen Gábor'un ölümü", tur:"olum", onem:4, dunya:2, kapsam:"ic",
  etiket:["hukumdar"],
  yer_id:"Erdel Belgradı (Gyulafehérvár)",
...
{ t:"1657-01-01", b:"II. Rákóczi György'nin talihsiz Lehistan seferi", tur:"savas", onem:4, dunya:2, kapsam:"dis",
  etiket:["askeri","kriz"],
  yer_id:"",
...
{ t:"1682-08-01", b:"Thököly İmre'nin Orta Macar Krallığı'nı (Osmanlı vasalı) kurması", tur:"kurulus", onem:4, dunya:2, kapsam:"ic",
  ...
  yer_id:"Kassa (Košice)",
  d:"Kanuni'nin ardından Osmanlı, Thököly'yi Kassa merkezli Kuzey-Doğu Macaristan üzerinde vasal 'kral' olarak tanıdı; Kassa, Eperjes ve Tokaj gibi şehirler bu kısa ömürlü vasal devletin merkezleri oldu. Yapı, 1683 Viyana bozgunundan sonra hızla çözülecekti.",
...
{ t:"1686-09-02", b:"Budin'in Habsburglar tarafından geri alınması", tur:"toprak-kazanc", onem:5, dunya:3, kapsam:"dis",
  etiket:["askeri","toprak-kazanc"],
  yer_id:"Budin",
...
{ t:"1687-08-12", b:"İkinci Mohaç (Harsány) zaferi", tur:"savas", onem:3, dunya:2, kapsam:"dis",
  etiket:["askeri"],
  yer_id:"Mohaç",
...
{ t:"1687-12-09", b:"Pressburg Diyeti — Macar tacının Habsburg hanedanında kalıtsallaşması", tur:"reform", onem:5, dunya:1, kapsam:"ic",
  etiket:["reform","kanun","kriz"],
  yer_id:"Bratislava",
...
{ t:"1697-09-11", b:"Zenta zaferi", tur:"savas", onem:3, dunya:3, kapsam:"dis",
  etiket:["askeri"],
  yer_id:"",
...
{ t:"1723-06-19", b:"Macar Diyeti'nin Pragmatik Yaptırım'ı onaylaması", tur:"kanun", onem:5, dunya:3, kapsam:"ic",
  etiket:["kanun","reform","hanedan"],
  yer_id:"Bratislava",
...
{ t:"1741-09-11", b:"Macar Diyeti'nin 'Vitam et sanguinem' desteği — Maria Theresia'ya silahlı yemin", tur:"ittifak", onem:5, dunya:3, kapsam:"dis",
  etiket:["ittifak","askeri","hukumdar"],
  yer_id:"Bratislava",
...
{ t:"1738-01-01", b:"Büyük veba salgınının Güney Macaristan'ı vurması", tur:"diger", onem:2, dunya:1, kapsam:"ic",
  etiket:["salgin","sosyal"],
  yer_id:"", kapsam_genis:true,
...
{ t:"1830-01-01", b:"Széchenyi'nin 'Hitel' (Kredi) adlı eserinin yayımlanması", tur:"kultur", onem:4, dunya:1, kapsam:"ic",
...
{ t:"1844-11-13", b:"Macarcanın tam resmî devlet dili ilan edilmesi", tur:"kanun", onem:4, dunya:1, kapsam:"ic",
  etiket:["kanun","kultur"],
  yer_id:"Bratislava",
...
{ t:"1848-03-15", b:"Pest Devrimi — 12 Nokta ve basın özgürlüğü", tur:"isyan", onem:5, dunya:4, kapsam:"ic",
  etiket:["isyan","kanun","kultur"],
  yer_id:"Peşte",
...
{ t:"1848-04-11", b:"Nisan Yasaları'nın (April Laws) onaylanması", tur:"kanun", onem:5, dunya:4, kapsam:"ic",
  etiket:["kanun","reform"],
  yer_id:"Bratislava",
...
{ t:"1848-09-29", b:"Pákozd Muharebesi — Hırvat Ban'ı Jelačić'in bozgunu", tur:"savas", onem:4, dunya:2, kapsam:"ic",
  etiket:["askeri"],
  yer_id:"",
...
{ t:"1850-01-01", b:"Bach döneminin merkezîleştirici idaresinin kurulması", tur:"idari", onem:4, dunya:1, kapsam:"ic",
  etiket:["idari","kriz"],
  yer_id:"", kapsam_genis:true,
...
{ t:"1854-03-02", b:"Urbéri kárpótlás — serflik tazminatının yasal çerçevesinin tamamlanması", tur:"reform", onem:3, dunya:1, kapsam:"ic",
  etiket:["mali","reform"],
  yer_id:"", kapsam_genis:true,
...
{ t:"1859-06-24", b:"Solferino bozgununun Bach sisteminin çöküşünü hızlandırması", tur:"kriz", onem:3, dunya:4, kapsam:"dis",
  etiket:["askeri","kriz"],
  yer_id:"",
...
{ t:"1867-03-30", b:"Ausgleich — Avusturya-Macaristan ikili monarşisinin kurulması", tur:"bolunme", onem:5, dunya:2, kapsam:"ic",
...
{ t:"1868-11-17", b:"Hırvat-Macar Uzlaşması (Nagodba)", tur:"antlasma", onem:3, dunya:2, kapsam:"ic",
...
{ t:"1873-05-09", b:"Viyana borsa çöküşünün Macar ekonomisine sıçraması", tur:"kriz", onem:4, dunya:3, kapsam:"dis",
  etiket:["ekonomi","kriz"],
  yer_id:"",
...
{ t:"1875-01-01", b:"Tisza Kálmán'ın Liberal Parti'yi kurup on beş yıllık iktidarını başlatması", tur:"siyaset", onem:4, dunya:1, kapsam:"ic",
...
{ t:"1878-01-01", b:"Avusturya-Macaristan Gümrük ve Ticaret Birliği'nin on yıllık yenilenmesi", tur:"ekonomi", onem:2, dunya:1, kapsam:"ic",
  etiket:["ekonomi","antlasma"],
  yer_id:"", kapsam_genis:true,
...
{ t:"1896-05-02", b:"Kontinental Avrupa'nın ilk yeraltı metrosunun (Földalatti) Budapeşte'de açılışı", tur:"kultur", onem:4, dunya:2, kapsam:"ic",
  etiket:["bilim","kultur","ekonomi"],
  yer_id:"Peşte",
...
{ t:"1905-01-19", b:"1905 seçim krizi — Ferenc József'in genel oy tehdidiyle Liberal Parti'ye baskısı", tur:"kriz", onem:3, dunya:2, kapsam:"ic",
  etiket:["siyaset","kriz"],
  yer_id:"Peşte",
...
{ t:"1908-01-01", b:"'Nyugat' (Batı) edebiyat dergisinin çıkışı — Macar modernizminin başlangıcı", tur:"kultur", onem:4, dunya:1, kapsam:"ic",
  etiket:["kultur","edebiyat"],
  yer_id:"Peşte",
...
{ t:"1914-07-28", b:"Avusturya-Macaristan'ın Sırbistan'a savaş ilanı", tur:"savas", onem:5, dunya:5, kapsam:"dis",
