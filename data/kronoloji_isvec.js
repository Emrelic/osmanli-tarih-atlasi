...
{ t:"1523-06-06", b:"Gustav Vasa, Strängnäs'te kral seçildi ⭐", tur:"kurulus", onem:5, dunya:4, kapsam:"dis",
  etiket:["kurulus","siyaset"],
  d:"Riksdag, Gustav Eriksson'u kral seçti ve İsveç, Kalmar Birliği'nden fiilen ayrıldı. Tarih bugün İsveç'in millî günüdür ve bu dosyada devletin başlangıç tarihi (data/", ic_not_d:"devletler.js:824 ile birebir) olarak alınmıştır.",
...
{ t:"1658-02-26", b:"Roskilde Antlaşması — Skåne, Blekinge, Halland, Bohuslän kazanıldı ⭐", tur:"toprak-kazanc", onem:5, dunya:3, kapsam:"dis", yer_id:"Malmö",
  etiket:["toprak","antlasma"],
  d:"Danimarka'ya karşı kazanılan savaş sonunda imzalanan Roskilde Antlaşması, İsveç'e güney yarımadasının tamamını (Skåne, Blekinge, Halland, Bohuslän) kazandırdı ve bugünkü İsveç sınırlarının çekirdeğini oluşturdu. Malmö'nün aynı gün İsveç idaresine geçtiği data/", ic_not_d:"yerlesimler_avrupa.js:312 kaydıyla birebir doğrulanır.",
...
{ t:"1790-08-14", b:"Värälä Barışı — savaş statüko ile bitti", tur:"antlasma", onem:3, dunya:2, kapsam:"dis",
  etiket:["antlasma"],
  d:"Savaş öncesi sınırları aynen koruyan Värälä Barışı imzalandı; toprak değişmedi ama Rusya, İsveç'in iç anayasal düzenine müdahale hakkını (1720'den beri iddia ettiği) resmen terk etti. TDV'nin", ic_not_d:"`isvec` maddesi bu antlaşmayla İsveç'in savaştan çekildiğini doğrular.",
...
{ t:"1808-02-21", b:"Rusya, Finlandiya'yı istila etti (Fin Savaşı başladı)", tur:"savas", onem:5, dunya:3, kapsam:"dis", yer_id:"Helsinki",
  etiket:["askeri","toprak"],
  d:"Napolyon'un Tilsit'te Rusya'ya verdiği serbestlikten yararlanan I. Aleksandr, hazırlıksız yakalanan İsveç'e karşı Finlandiya'yı istila etti. Helsinki'nin bu tarihten itibaren fiilen Rus denetimine girdiği süreç, data/", ic_not_d:"yerlesimler.js:907 kaydındaki 1809-09-17 devir tarihiyle örtüşür.",
