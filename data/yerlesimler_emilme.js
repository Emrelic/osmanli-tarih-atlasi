...
{ ad:"Zanzibar (Zengibar)", tur:"sehir", lat:-6.1659, lon:39.1917, g:2, k:0,
...
{ ad:"Mombasa", tur:"liman", lat:-4.0402, lon:39.6794, g:1, k:0,
...
{ ad:"Mbanza-Kongo (São Salvador)", tur:"sehir", lat:-6.27, lon:14.24, g:2, k:0,
  kur:"1390-01-01", kasitli_bosluk:true, neden:"kongo-kralligi künyesi 1390'da başlıyor; öncesinde bu noktada merkezi bir devlet kaydı yok",
...
{ ad:"Matadi", tur:"liman", lat:-5.818, lon:13.460, g:0, k:0,
  kur:"1390-01-01", kasitli_bosluk:true, neden:"kongo-kralligi künyesi 1390'da başlıyor; öncesinde bu noktada merkezi bir devlet kaydı yok",
  s:[{f:"1390-01-01",t:"1885-01-01",d:"kongo-kralligi"},{f:"1885-01-01",t:"1923-10-29",d:"belcika"}] },
{ ad:"Kabasa", tur:"sehir", lat:-9.30, lon:15.15, g:1, k:0,
  kur:"1500-01-01", kasitli_bosluk:true, neden:"ndongo künyesi 1500'de başlıyor (ÖLÇÜLDÜ: 1500/1518 muhtemelen Portekiz'in ilk BELGELENMİŞ teması, krallığın kendisi muhtemelen daha erken Kongo'ya bağlı bir eyalet olarak vardı — net bir alternatif tarih kaynaklarda YOK, künyeye dokunmadım)",
...
{ ad:"Musumba", tur:"sehir", lat:-8.30, lon:22.42, g:1, k:0,
  kur:"1665-01-01", kasitli_bosluk:true, neden:"lunda-imparatorlugu künyesi 1665'te başlıyor; öncesinde bu noktada merkezi bir devlet kaydı yok",
...
{ ad:"Boma", tur:"liman", lat:-5.85, lon:13.05, g:0, k:0,
  kur:"1885-01-01", kasitli_bosluk:true, neden:"kolonyal dönem öncesi bu spesifik nehir ağzı noktasında merkezi bir devlet kaydı yok",
  s:[{f:"1885-01-01",t:"1923-10-29",d:"belcika"}] },
{ ad:"Kisangani (Stanleyville)", tur:"sehir", lat:0.515, lon:25.191, g:0, k:0,
  kur:"1885-01-01", kasitli_bosluk:true, neden:"kolonyal dönem öncesi bu spesifik iç-nehir noktasında merkezi bir devlet kaydı yok",
  s:[{f:"1885-01-01",t:"1923-10-29",d:"belcika"}] },
{ ad:"Loango (Buali)", tur:"sehir", lat:-4.6546, lon:11.8050, g:1, k:0,
  kur:"1550-01-01",
...
{ ad:"Madang", tur:"liman", lat:-5.22, lon:145.79, g:0, k:0,
  kur:"1884-11-03", kasitli_bosluk:true, neden:"1884 Alman ilhakından önce bu kıyı şeridinde yerli köyler dışında merkezi bir devlet yoktu — boşluk veri eksikliği değil, gerçek siyasi boşluk",
