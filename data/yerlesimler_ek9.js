...
{ ad:"Berezov", tur:"kale", lat:63.9364, lon:65.0489, g:0, k:0, d:[],
  kasitli_bosluk:true, neden:"1592 öncesi Hantı (Yugra) toprağı; TDV sibir-hanligi hanlığın sınırını Tura-Tobol-İşim ve İrtiş civarı diye veriyor, aşağı Ob' bu sınırın dışında.",
  s:[{f:"1592-01-01",t:"1923-10-29",d:"rusya"}] },

{ ad:"Surgut", tur:"kale", lat:61.2540, lon:73.3962, g:0, k:0, d:[],
  kasitli_bosluk:true, neden:"Berezov ile aynı gerekçe ve aynı TDV cümlesi.",
  s:[{f:"1592-01-01",t:"1923-10-29",d:"rusya"}] },

{ ad:"Tomsk", tur:"kale", lat:56.4884, lon:84.9480, g:0, k:0, d:[],
  kasitli_bosluk:true, neden:"1604 öncesi Teleüt/Selkup toprağı, devletsiz. 🔴 1604 TDV'ye basmıyor.",
  s:[{f:"1604-01-01",t:"1923-10-29",d:"rusya"}] },

// ── ② YENİSEY HAVZASI ───────────────────────────────────────────────
{ ad:"Yeniseysk", tur:"kale", lat:58.4494, lon:92.1683, g:0, k:0, d:[],
  kasitli_bosluk:true, neden:"1619 öncesi Ket/Evenk toprağı, devletsiz. 🔴 TDV'ye basmıyor.",
  s:[{f:"1619-01-01",t:"1923-10-29",d:"rusya"}] },

{ ad:"Krasnoyarsk", tur:"kale", lat:56.0106, lon:92.8526, g:0, k:0, d:[],
  kasitli_bosluk:true, neden:"1628 öncesi Yenisey Kırgızları'nın otlağı; atlasta karşılığı olan bir kimlik yok ve UYDURULMADI. 🔴 TDV'ye basmıyor.",
...
{ ad:"Yakutsk", tur:"kale", lat:62.0281, lon:129.7325, g:0, k:0, d:[],
  kasitli_bosluk:true, neden:"1632 öncesi Yakut (Saha) toprağı, devletsiz. 🔴 TDV'ye basmıyor.",
  s:[{f:"1632-01-01",t:"1923-10-29",d:"rusya"}] },

{ ad:"Olyokminsk", tur:"kale", lat:60.3742, lon:120.4064, g:0, k:0, d:[],
  kasitli_bosluk:true, neden:"1635 öncesi Evenk toprağı, devletsiz. 🔴 TDV'ye basmıyor.",
...
{ ad:"Ohotsk", tur:"liman", lat:59.3631, lon:143.2431, g:0, k:0, d:[],
  kasitli_bosluk:true, neden:"1647 öncesi Even/Lamut toprağı, devletsiz. 🔴 TDV'ye basmıyor.",
...
{ ad:"İrkutsk", tur:"kale", lat:52.2870, lon:104.2810, g:0, k:0, d:[],
  kasitli_bosluk:true, neden:"1661 öncesi Buryat toprağı. ⚠️ Halha/Altan Han nüfuzu tartışılabilir; `kuzey-yuan` YAZILMADI çünkü kaynakla ayıramadım — bilgisizliği kasıt gibi göstermemek için boş bırakıldı (girdi.py'nin `kasitli_bosluk` notu).",
  s:[{f:"1661-01-01",t:"1923-10-29",d:"rusya"}] },

{ ad:"Nerçinsk", tur:"kale", lat:51.9494, lon:116.5772, g:0, k:0, d:[],
  kasitli_bosluk:true, neden:"1653 öncesi Evenk/Daur toprağı. 🔴 TDV'ye basmıyor.",
...
{ ad:"Albazin", tur:"kale", lat:53.3800, lon:124.0930, g:0, k:0, d:[],
  kasitli_bosluk:true, neden:"1651 öncesi Daur toprağı, devletsiz. 🔴 1651 · 1689-09-06 · 1858-05-28 TDV'ye basmıyor.",
