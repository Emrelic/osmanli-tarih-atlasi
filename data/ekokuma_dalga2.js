...
{ id:"tartisma-osman-gazi-olum-yili", tur:"tartisma",
  ...
  bag:"İki anlatı aynı şeyi ölçmüyor. Vakfiyeler bir belge tarihidir ve 1324'ü destekler; ölümün Bursa kuşatmasına bağlanması kronik geleneğinden gelir. Hastalanıp işleri çoktan oğluna bırakmış bir bey için \"Bursa'yı gördü\" demek de \"görmeden öldü\" demek de ayrı iddialardır. Atlastaki iki madde bu ayrımı yan yana taşıyor: vefat maddesi 1324'ü, Bursa maddesi ise rivayeti veriyor.",
  not:"Bursa maddesindeki \"fetih haberi ölüm döşeğindeki Osman'a ulaştırıldı\" ayrıntısı okunan TDV gövdelerinde (osman-i · orhan · bursa) geçmiyor; TDV yalnız \"öldüğünde Orhan Bursa'yı kuşatıyordu\" rivayetini aktarıyor.",
  kesinlik:"tartismali",
...
{ id:"savas-bursa-1326", tur:"savas-hikayesi",
  ...
  taraflar:[
    ...
    { ad:"Bizans'a bağlı Bursa kalesi", komutan:"Bursa tekfuru (adı okunan kaynaklarda geçmiyor)", kuvvet:"kaynakta sayı verilmiyor" }
  ],
...
{ id:"kimdir-orhan-gazi", tur:"kimdir",
  ...
  not:"Ölüm sebebinin veba olduğu bilgisini TDV Bizans kısa kroniklerinin neşrine (Schreiner) dayandırır. Atlastaki 1362 vefat maddesi \"TDV'de Orhan Gazi'nin müstakil maddesi yok\" notunu taşıyor; oysa `orhan` slugu HTTP 200 veriyor ve gövdesi Orhan Gazi'yi anlatıyor.",
  kesinlik:"kesin",
  olay:["1362-03-01"],
...
{ id:"savas-trabzon-1461", tur:"savas-hikayesi",
  ...
  tartisma:"TDV'nin Trabzon maddesi teslimi \"Ağustos veya Eylül 1461\" diye iki ihtimalle verir; kuşatmanın süresi de kaynaklara göre dört ile altı hafta arasında değişir. Atlastaki 15 Ağustos günü okunan TDV gövdelerinde geçmiyor. Ayrıca kuyruk kronolojide aynı güne yazılmış Amasra'nın düşüşünü TDV'nin II. Mehmed maddesi 1459 yazına, Semendire seferinin hemen ardına koyar.",
  kesinlik:"tartismali",
