...
{ id:"magazin-nurbanu-safiye-murad-iii", tur:"magazin",
  ...
  metin:"III. Murad'ın annesi Nurbânû Sultan'ın, oğlunun ilk ve tek aşkı Safiye Sultan'ın nüfuzunu kırmak için ona sürekli cariye sunduğu, III. Murad'ın buna rağmen kırk dokuz çocuğa (TDV'nin verdiği belgeli, ölümündeki sağ çocuk sayısı — 'yüz civarı' gibi rivayetleri TDV açıkça MÜBALAĞALI bulur) sahip olduğu, ve bu kalabalık haremin 1595'te oğlu III. Mehmed'in on dokuz kardeşini tek gecede boğdurtmasına zemin hazırladığı — bu zincirin TAMAMI atlasta zaten ayrıntılı işlenmiş durumda: kadın biyografileri için 'kimdir-nurbanu-sultan' ve 'kimdir-safiye-sultan' kartları (data/ekokuma_kadin.js), sebep-sonuç zinciri için 'sebep-sonuc-1595-on-dokuz-sehzade' kartı (data/ekokuma_hanedan.js) — ikincisi III. Mehmed'in 1603'te öz oğlu Şehzade Mahmud'u da öldürttüğünü bile içeriyor.\n\nBu kart yeni bir araştırma değil, paketin istediği konuyu (H-0004) atlasın zaten sahip olduğu doğru adrese YÖNLENDİRİYOR — aynı bilgiyi ikinci kez, daha zayıf kaynaklarla yazmak yerine.",
  kesinlik:"kesin",
...
{ id:"tartisma-sehzade-mahmud-tarih-bulgusu", tur:"tartisma",
  ...
  metin:"III. Mehmed'in kendi öz oğlu Şehzade Mahmud'u, büyük oğlunun tahtına göz koyduğu ve askerî çevrelerin onu desteklediği şüphesiyle boğdurtması — annesi ve otuz kadar hizmetçisinin de denize atılması — atlasta 'sebep-sonuc-1595-on-dokuz-sehzade' kartında (data/ekokuma_hanedan.js) zaten anlatılıyor. O kartın kendi notu şöyle diyordu: 'Mahmud'un katli için TDV gün vermiyor (Lello'ya atıf); atlasta madde yok, kart 1603-12-22'ye bağlandı.'\n\n🔴 BU OTURUMUN BAĞIMSIZ TDV TARAMASI FARKLI BİR SONUÇ BULDU: TDV'nin 'mehmed-iii' maddesinin okunan gövdesinde ölüm tarihi AÇIKÇA veriliyor — '27 Zilhicce 1011 / 7 Haziran 1603.' Bu, önceki oturumun 'TDV gün vermiyor' bulgusuyla ÇELİŞİYOR.\n\nİki ihtimal var: (a) TDV maddesi iki oturum arasında güncellenmiş olabilir, (b) iki ayrı WebFetch/okuma turu maddenin farklı bölümlerini görmüş olabilir. Bu kart taraf TUTMAZ — koordinatöre iki tarihi de bildirir (7 Haziran 1603 vs. şimdiki yer tutucu 22 Aralık 1603) ve TDV 'mehmed-iii' maddesinin gövdesinin BİR KEZ DAHA, dikkatle, tam olarak okunmasını önerir. Doğrulanırsa, atlasın ilgili kartındaki '1603-12-22' bağı '1603-06-07'ye düzeltilmeli — ama bu düzeltmeyi ekokuma_hanedan.js dosyasının SAHİBİ yapmalı (CLAUDE.md §7), bu oturum değil.",
  kesinlik:"tartismali",
...
{ id:"tartisma-ibrahim-culus-rivayeti", tur:"tartisma",
  ...
  metin:"Sultan İbrahim'in 1640'taki tahta çıkışıyla ilgili rivayetler atlasın 'data/ekokuma_ibrahim.js' dosyasında ('İbrahim ağabeyinin öldüğüne neden inanmadı?' kartı) zaten ayrıntılı işlenmiş: kardeşinin öldüğüne inanmayıp bunu bir tuzak sanarak odasından çıkmadığı, annesi Kösem Sultan'ın ikna ettiği, Naîmâ'nın anlatısına göre cesedi GÖRMEKLE YETİNMEYİP emin olmak için İKİ KEZ baktığı — hepsi kaynaklı. Ayrıca IV. Murad'ın ölüm döşeğinde kardeşini öldürtmek istediği (Du Loir, TDV'nin kendisi 'şüpheli' diye damgalar) ve TAM TERSİ olarak tahtı ona vasiyet ettiği (Solakzâde) yönünde İKİ ÇELİŞEN rivayet de o kartta yer alır.\n\nBu oturumun bağımsız TDV taraması AYNI sonuca ulaştı: 'ayaklarını gıdıklayarak öldüğünden emin olma' detayı — kullanıcının paket metninde andığı popüler versiyon — ne TDV'de ne akademik kaynakta bulunabildi. İki ayrı araştırma (önceki oturum ve bu oturum) birbirinden bağımsız olarak aynı BULUNAMADI sonucuna vardı — bu, bulgunun güvenilirliğini artırır.",
  kesinlik:"tartismali",
  olay:["1640-02-09"],
...
{ id:"tartisma-ibrahim-skandal-figurleri", tur:"tartisma",
  ...
  metin:"Sultan İbrahim döneminin (1640-1648) üç skandal figürü — Cinci Hoca (Hüseyin Efendi), Hezarpâre Ahmed Paşa ve Varvar Ali Paşa — atlasın 'data/ekokuma_ibrahim.js' dosyasında zaten TEK TEK, akademik kaynaklarla (TDV + Volkan Çeribaş, OTAM 51/2022) derinlemesine işlenmiş durumda: kuvvetli nefesiyle ün salıp kazaskerliğe yükselen, sonra evinden sandıklar dolusu altınla çıkan Cinci Hoca; ölümünden SONRA cesedinin parçalanmasından adını alan Hezarpâre Ahmed Paşa; İpşir Mustafa Paşa'nın karısı Perihan Hanım'ın saraya gönderilmesini reddedip isyan eden ve sonunda o kocanın eliyle idam edilen Varvar Ali Paşa.\n\nÜçü de aynı çöküş resminin parçası: saray nüfuzunun satın alınabilir hâle gelmesi, taşra valilerinin merkeze başkaldırması, ve dönemin padişahın kendisinin de (Ağustos 1648) aynı şiddetle tahttan indirilip öldürülmesiyle kapanması (bk. Şüpheli Ölümler kartı, madde ⑫).",
  kesinlik:"kesin",
  olay:["1648-08-18"],
