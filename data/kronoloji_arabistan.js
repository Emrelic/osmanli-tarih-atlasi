...
{ t:"1905-04-01", b:"İmam Yahyâ San'a'yı kuşatıp ele geçirdi", tur:"toprak-kazanc",
  ...
  yer_id:"Sana",
  d:"Ahmed Feyzi Paşa'nın San'a'ya girmesinden yalnızca birkaç ay önce, İmam Yahyâ kuvvetleri şehri kısa süreliğine ele geçirdi.", ic_not_d:"Tarih yerlesimler.js'teki San'a kaydında (1905-04-01 → 1905-09-01 arası 'yemen') GÜN GÜNÜNE bir mikro-pencere olarak görünüyor — haritanın en ince taneli doğrulamalarından biri.",
...
{ t:"1650-01-26", b:"Maskat, Portekiz'den geri alındı", tur:"toprak-kazanc",
  ...
  yer_id:"Maskat",
  d:"Sultân b. Seyf komutasındaki Ya'rubî kuvvetleri, Portekiz'in 143 yıldır elinde tuttuğu Maskat'ı geri aldı — Uman'ın kendi başkentini Avrupa sömürgeciliğinden kurtardığı dönüm noktası ve bölgedeki Portekiz varlığının fiilen sonu.", ic_not_d:"Tarih data/yerlesimler.js Maskat kaydıyla (1650-01-26) birebir örtüşüyor.",
...
{ t:"1749-06-10", b:"Bû Saîd hanedanı resmen kuruldu", tur:"kurulus",
  onem:5, dunya:2, kapsam:"ic", etiket:["kurulus","hukumdar","konu-siyasi","konu-hanedan"],
  yer_id:"",
  d:"Ahmed b. Saîd'in imamet makamını resmen ve kalıcı olarak devralmasıyla, bugüne (site ufkunun ötesine, 2020'lere) kadar sürecek Bû Saîd hanedanı kuruldu.", ic_not_d:"Tarih devletler.js'teki `umman` künyesinin kendi f: alanıyla birebir aynıdır.",
...
{ t:"1670-01-01", b:"Berrâk b. Guraybir, Hufuf'u alarak Benî Hâlid emirliğini kurdu", tur:"kurulus",
  ...
  yer_id:"",
  d:"Berrâk b. Guraybir, Lahsa'nın merkezi Hufuf'u ele geçirip Osmanlı idaresine son vererek bedevi Benî Hâlid emirliğini kurdu.", ic_not_d:"bu, devletler.js'teki `benihalid` künyesinin f: alanıdır. TDV'nin `lahsa` maddesinde bu kuruluş olayı doğrudan anlatılmıyor — devletler.js'in kendi araştırdığı bilgiye güvenilerek DEVRALINDI.",
...
{ t:"1744-01-01", b:"Muhammed b. Abdülvehhâb'ın Dir'iye'ye sığınması — Suûdîlerle husumet başladı", tur:"savas",
  onem:3, dunya:2, kapsam:"dis", etiket:["din","siyaset","konu-askeri","konu-siyasi","konu-din"],
...
{ t:"1752-01-01", b:"Süleyman el-Hamîdî tahttan indirildi — iç çekişmeler başladı", tur:"bolunme",
  onem:3, dunya:1, kapsam:"ic", etiket:["bolunme","siyaset","taht-kavgasi","konu-siyasi","konu-darbe","konu-hanedan"],
  yer_id:"",
