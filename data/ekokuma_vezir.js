...
{ id:"kimdir-rustem-pasa", tur:"kimdir",
  ...
  not:"Rüstem Paşa tabii ölümle öldü; onu Şehzade Mustafa idamıyla anmak farklı bir tartışmadır — kendi ölümüyle karıştırılmamalı.",
  kesinlik:"kesin",
  olay:["1544-12-02"],
...
{ id:"kimdir-koca-ragib-pasa", tur:"kimdir",
  ...
  not:"Ragıp Paşa tabii ölümle öldü — bir idam değildi.",
  kesinlik:"kesin",
  olay:["1763-04-08"],
...
{ id:"kimdir-nevsehirli-damad-ibrahim-pasa", tur:"kimdir",
  ...
  kesinlik:"kesin",
  olay:["1730-10-01"],
  kaynak:"TDV: damad-ibrahim-pasa-nevsehirli (kart genişletildi: sadrazamlık öncesi kariyeri, Yirmisekiz Çelebi Mehmed Efendi elçiliği, lale yetiştiriciliğinin simgesel önemi, idam sahnesinin ayrıntısı, Fatma Sultan'ın önceki evliliği)" },
...
{ id:"kimdir-koprulu-mehmed-pasa", tur:"kimdir",
  ...
  not:"Köprülüler hanedanı bu dört isimle sınırlı değildir: torun Amcazâde Hüseyin Paşa (Karlofça'yı imzalayan sadrazam) ve daha sonraki nesiller de sadaret makamına ulaştı; ",
  kesinlik:"kesin",
  olay:["1656-09-15"],
...
{ id:"kimdir-koprulu-fazil-ahmed-pasa", tur:"kimdir",
  ...
  kesinlik:"kesin",
  olay:["1661-11-01"],
  kaynak:"TDV: kopruluzade-fazil-ahmed-pasa (kart genişletildi: Saint Gotthard/Vasvar, Köprülü Kütüphanesi ve himaye ettiği isimler, ölüm sebebi)" },
...
{ id:"kimdir-ali-pasa-mehmed-emin", tur:"kimdir",
  ...
  not:"Ölümünden sonraki beş yıl içinde maliye iflas etti, Balkanlar ayaklandı ve saltanat değişikliği kaçınılmaz hâle geldi — bu sayfanın kendi kaydı Âli Paşa'nın ölümünü Tanzimat kadrosunun sonu olarak işaretler.",
  kesinlik:"kesin",
  olay:["1871-09-07"],
