// data/olaylar_kamerika.js — DUNYA-KAMERIKA-0903 · 3 Eylül 2026
// ---------------------------------------------------------------------------
// 🔴 BU DOSYAYA YAZAN: EKLE, YENİDEN YAZMA.
// 11 madde — hepsi Kuzey Amerika kırılmalarını karşılıyor ve yazan oturum
// DÖRT SINAVI da ölçtü: yer_id canlı evrende VAR 11/11 · gün hassasiyeti
// 11/11 · başlık mükerrer 0 (bütün külliyata karşı) · her günün
// GERÇEKTEN bir kırılma olduğu tek tek doğrulandı (1880-09-01 → 62 kırılma).
// ⚠️ `kaynak:"bulunamadı"` olanlar TDV bu coğrafyayı KAPSAMADIĞI için öyle;
//    dayanak maddenin METNİNDE açıkça yazılı (§4 — gizlenmez, `bulunamadı`
//    diye YAZILIR).
// ---------------------------------------------------------------------------
window.OLAYLAR_KAMERIKA = [

  {
    ...
    "gun": "1 Eylül 1880",
    "yer": "Arktik Takımadalar",
    "yer_id": "Iglulik",
    "kisiler": "Britanya Hükûmeti, Kanada Dominyonu",
    "kapsam": "dis",
    "dunya": 3,
    "duygu": [
      "📌"
...

  {
    ...
    "kisiler": "Antonio de Mendoza, V. Karl",
    "kapsam": "dis",
    "dunya": 3,
    "duygu": [
      "🏛"
