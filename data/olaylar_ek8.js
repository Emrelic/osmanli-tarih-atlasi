...
{ t:"1468-01-01", tur:"hukumdar", etiket:["hanedan-degisimi"], b:"Kâsım Han'ın ölümü, Danyal Han'ın tahta çıkışı (Kasım Hanlığı)", gun:"873 (1468) — TDV gün vermiyor", yer:"Kasimov", kisiler:"Kâsım Han (öldü), Danyal Han (tahta çıktı)", d:"Hanlığın kurucusu Kâsım Han'ın 873/1468'de ölümüyle yerine oğlu Danyal geçti; Danyal 1486'ya kadar hüküm sürdü.", kaynak:"kasim-hanligi (TDV — CANLI, madde gövdesinde birebir tarih)" },

{ t:"1573-01-01", tur:"siyaset", etiket:["din","hanedan-degisimi"], b:"Kasım Hanlığı hükümdarının Hıristiyanlığa geçişi ve hanlıktan alınması", gun:"1573 — TDV gün vermiyor", yer:"Kasimov / Moskova", kisiler:"Sain Bulat Han (Simeon Bekbulatoviç)", d:"Hanlığın başındaki hükümdar 'Semen (Simeon)' adını alıp Hıristiyan oldu; Ruslar müslüman tebaanın tepkisini hesaba katarak onu hanlıktan aldılar. Bu kişi kısa süre sonra Korkunç İvan tarafından 'çarın ve Rusya'nın büyük beyi' unvanıyla Moskova'da nominal hükümdar ilan edildi (1575) — Kasım Hanlığı ile Moskova tahtı arasındaki en çarpıcı kesişme.", kaynak:"kasim-hanligi (TDV — CANLI, madde gövdesinde birebir tarih ve bağlam)" },

{ t:"1609-01-01", tur:"kayip", etiket:["askeri","isyan"], b:"Rus kuvvetlerinin Kasım şehrini zaptı, Uraz Muhammed Han", gun:"1609 — TDV gün vermiyor", yer:"Kasimov", kisiler:"Uraz Muhammed Han, II. Sahte Dimitri", d:"Rusya'daki İç Karışıklıklar Devri'nin (Smuta) yansıması olarak Rus kuvvetleri Kâsım şehrini kuşatıp zaptetti, halkının çoğunu kılıçtan geçirdi. Hanlığın başındaki Uraz Muhammed, II. Sahte Dimitri'yi desteklediği için hedef alınmıştı; ertesi yıl (1610) kendisi de bir komployla öldürüldü.", kaynak:"kasim-hanligi (TDV — CANLI, madde gövdesinde birebir tarih ve bağlam)" },
