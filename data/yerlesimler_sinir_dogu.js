...
{ad:"Şeyhrumi (Yücelen)", tur:"koy", lat:38.9619, lon:44.1132, g:0, k:4, m:null,
 ...
 s:[{f:"1281-01-01",t:"1351-01-01",d:"ilhanli"},{f:"1351-01-01",t:"1467-01-01",d:"karakoyunlu"},{f:"1467-01-01",t:"1502-01-01",d:"akkoyunlu"},{f:"1502-01-01",t:"1548-08-24",d:"safevi"},{f:"1920-04-23",t:"1923-10-29",d:"tbmm-turkiye"}],
 d:[{f:"1548-08-24",t:"1920-04-23"}],
 kaynak:"GeoNames (CC BY 4.0), allCountries 31 Ağu 2026: 38.9619 K / 44.1132 D, feature class P. `alternatenames` tarihî adı veriyor: 'Sehrumi, Seyhrumi, Şehrumi, Şeyhrumi' — 'Yücelen' 1950-60 yeniden adlandırmasıdır, 1923 haritasına yazılamaz. ⚠️ TDV bu taneciği kapsamıyor. ⚠️ Ve açıkça: yerleşimin varlığı ve konumu doğrulandı, 1923'te de var olduğu AYRICA BELGELENEMEDİ. ~~Dönem zinciri en yakın komşu Çaldıran'dan (26,8 km) BİREBİR alındı (safevi →1639-05-17).~~ 🔴 PAKET-KRON4 (14 Eylül 2026) ZİNCİRİ DEĞİŞTİRDİ — H-0001 Çaldıran/Başkale hükmüyle AYNI SINIF: İŞARET, doğrudan kanıt DEĞİL. Köyün KENDİ Osmanlı dönem kaydı ve bağlı olduğu sancak/nahiye BULUNAMADI. İşaretler: TDV `van` — Van Kalesi 24 Ağustos 1548'de fethedildi ve bir daha el değiştirmedi; eyalette devamlılığı olan sancaklar arasında Bargiri, Mahmudi ve Kotur sayılıyor · TDV `maku` — 1574'te Mahmûdî İvaz Bey Mâkû'yu İranlılar'dan almakla görevlendirildi, 1605'te I. Abbas kaleyi alamadı, 1639 Kasrışîrin çerçevesinde Kotur ve Mâkû kaleleri yıkıldı, IV. Murad'ın ölümünden sonra İran tekrar işgal etti · Karataş 2025 (Hacettepe Türkiyat Araştırmaları 43; ARAS-CALDIRAN-0913 raporundan, bu turda YENİDEN OKUNMADI): 1585 hükmünde 'Bargiri ma'a Kotur dere Beyi'. Konum (GeoNames koordinatı, kaynak iddiası değil): köy Bargiri (Muradiye) ile Kotur vadisi arasındaki kuşakta. Safevî tasarrufuna 1548-1639 arası işaret BULUNAMADI. GÜN komşudan (§4 şartlı): Van · TDV `van` '24 Ağustos 1548' — Çaldıran KAYDINDAN devralınmadı (zincirleme yasak). 1920-04-23 → tbmm-turkiye: proje kararı M-3066. ⚠️ 1548-1574 arası Mâkû Safevî'ydi (TDV `maku`); köyün o dilimde sınırın hangi yanında kaldığı ÖLÇÜLEMEDİ. 1281-1502 zinciri araştırılmadı, dokunulmadı.",
 neden:"PAKET-KRON4 · 1548-1639 tek başına safevi ADACIĞI kaldırıldı: zincir Çaldıran'ın 13 Eylül'de emekli edilen dayanaksız zincirinin kopyasıydı (ARAS-CALDIRAN-0913 §8.2); eşi Şeyh Salû-yi Ulyâ ve Çaldıran 1548-1639 Osmanlı iken bu köy Safevî boyanıyordu. sınır çifti: Şeyh Salû-yi Ulyâ (İran, bu dosyada) ile 8,2 km. Şeyhrumi sınıra 4,2 km, eşi 4,8 km ⇒ SİMETRİ FARKI 0,6 km, yani bisektör gerçek sınıra oturuyor. ÖLÇÜLDÜ: KUZEY-A kesiminin (38,70-39,20 K · 37 örnek ≈ 74 km) ortanca sapmasını 7,29 → 0,73 km'ye, ≤5km oranını %27 → %100'e taşıyor. 132 TR × 422 İR adayın tamamı tarandı, en iyisi bu. BU KOŞUDA ÇİZİLMEZ, bir sonrakine kalır."
},
