// ============================================================================
// DERİNLEŞTİRME PARTİSİ 17 — KRONOLOJİ İÇERİK
// Kaynak: denetim/kume/icerik-talebi.md, 38 madde. Emre'nin sözü: "kusur
// değil, bir maddeyi okuyup 'bunu da anlat' demek" — arka plan, kişinin
// akıbeti, ilginç olay. 4 paralel ajanla TDV İslâm Ansiklopedisi'nden
// (içerik okunarak, CLAUDE.md §4) araştırıldı; mükerrer olanlar YAZILMADI.
// Rapor: denetim/BULGU-KRONOLOJI-ICERIK.md
// ============================================================================
window.OLAYLAR_EK17 = [
...
{ t:"1617-11-22", b:"Yeni padişah I. Mustafa: solgun çehreli, dalgın bakışlı bir 'kafes' mahpusu tahtta", tur:"magazin",
  onem:3, dunya:1, kapsam:"ic", etiket:["saray","magazin","kisi"],
  yer_id:"İstanbul",
...
// ---------- IV. Murad dönemi ----------
{ t:"1632-01-01", b:"IV. Murad'ın çelişkileri: içkiye düşkün padişahın içki yasağı, güreşçi bileği, besteci kulağı", tur:"magazin",
  onem:3, dunya:2, kapsam:"ic", etiket:["kisi","magazin","saray"],
  yer_id:"İstanbul",
  d:"On bir yaşında tahta çıkan IV. Murad'ın ilk yıllarında annesi Kösem Sultan'ın nüfuzu belirleyiciydi; TDV İslâm Ansiklopedisi, Kösem'in oğlundaki iktidar eğiliminden çekinip onu 'eğlenceye sevkettiğini, hediye ve şenliklerle oyaladığını' aktarır. Yaklaşık yirmi yaşında yönetimi fiilen eline aldığında uzun boylu, geniş omuzlu, heybetli bir hükümdardı — güçlü bir adamı kuşağından tutup kaldırıp Has Oda'da birkaç kez dolaştırdığı rivayet edilir. TDV'nin kaydettiği çarpıcı çelişki şu: tütün ve afyondan nefret ettiği söylenen padişah içkiye aşırı düşkündü, buna rağmen sefer öncesi kahve, tütün ve daha sonra içkinin kendisini de yasakladı; aynı zamanda makam geleneğine uygun beste yapacak kadar mûsiki bilgisine sahipti.",
  kaynak:"murad-iv" },

{ t:"1632-01-01", b:"Lâgarî Hasan Çelebi'nin roketle uçuşu — Evliya Çelebi'nin tek kaynaklık ettiği rivayet", tur:"hikaye",
  onem:2, dunya:2, kapsam:"ic", etiket:["bilim","hikaye"],
  yer_id:"İstanbul",
  d:"Evliya Çelebi'nin Seyahatnâme'sine göre Lâgarî Hasan Çelebi, IV. Murad'ın huzurunda Sarayburnu'nda elli okka barutla yedi kollu bir fişek düzenek imal etti ve 'Padişahım, seni Hüdâ'ya ısmarladım, İsâ nebî ile konuşmaya gidiyorum' diyerek fişeğe bindi. Rivayete göre yaklaşık 250 metre yükselen Hasan Çelebi, doğan kanadına benzer aletlerle denize süzülerek yüzüp padişaha döndü ve karşılığında yetmiş akçe yevmiyeli bir sipahilik kazandı. ⚠️ TDV bu olayı yalnız bir hicrî yılla (1042/1632-33) tarihler ve güvenilirliği hakkında 'ilkel roket itki prensipleriyle teorik olarak mümkün' notunu düşer — olayın TEK KAYNAĞI Evliya Çelebi'dir, başka çağdaş tanıklık yoktur.",
  kaynak:"hasan-celebi-lagari" },

{ t:"1630-08-19", b:"Evliya Çelebi'nin seyahat rüyası — 'Şefaat' diyecekken 'Seyahat' demesi", tur:"hikaye",
  onem:2, dunya:2, kapsam:"ic", etiket:["kultur","hikaye","kisi"],
  yer_id:"İstanbul",
  d:"TDV İslâm Ansiklopedisi'ne göre Evliya Çelebi, kırk yıl sürecek gezi hayatının başlangıcını 1040 yılı Muharrem'inin aşure gecesinde (19 Ağustos 1630) gördüğü bir rüyaya bağlar: rüyasında İstanbul'daki Ahî Çelebi Camii'nde kalabalık bir cemaatle birlikte Hz. Peygamber'i görür ve heyecanından 'şefaat yâ Resûlellah' diyecek yerde 'seyahat yâ Resûlellah' der. Rivayete göre Hz. Peygamber bu dil sürçmesine tebessüm ederek ona hem şefaat hem seyahat hem de ziyaret müjdesini verir. Hiç evlenmemiş, hayatını bu 'seyahat' vaadine adamıştır.",
...
{ t:"1644-01-01", b:"'Deli İbrahim' mi, dalgalı bir hastalık mı? TDV etiketi reddediyor", tur:"tartisma",
  onem:3, dunya:1, kapsam:"ic", etiket:["kisi","tartisma","saray"],
  yer_id:"İstanbul",
  ...
  kaynak:"ibrahim--padisah" },

{ t:"1647-01-01", b:"Samur Vak'ası — Sadrazam Ahmed Paşa'nın kürk vergisi İbrahim'in sonunu hazırladı", tur:"sebep-sonuc",
  onem:3, dunya:1, kapsam:"ic", etiket:["ekonomi","isyan","saray"],
  yer_id:"İstanbul",
  d:"Sultan İbrahim'in samur kürkü ve amber merakı sarayda giderek büyürken, Sadrazam Ahmed Paşa 1647-1648 dolaylarında devlet erkânından zorla samur kürkü bedeli toplayan bir uygulama başlattı; TDV İslâm Ansiklopedisi görevlilerin bunu açık bir 'haraç' olarak gördüğünü kaydeder. Yeniçeri zâbitleri ödemeyi topluca reddedince bu direniş, padişahın tahttan indirilmesine giden sürecin doğrudan tetikleyicisi oldu — 7 Ağustos 1648 sabahı toplanan görevliler önce Ahmed Paşa'yı öldürdü, ertesi gün İbrahim'i indirdi.",
  kaynak:"ibrahim--padisah" },

{ t:"1648-05-01", b:"'Devleti kadınlar yönetiyor' — Varvar Ali Paşa'nın Sivas'tan başkaldırısı", tur:"isyan",
  onem:3, dunya:1, kapsam:"ic", etiket:["isyan","siyaset"],
  yer_id:"Sivas",
  d:"Sivas beylerbeyi Varvar Ali Paşa, İstanbul'un 'bayramiye' adıyla istediği 30.000 kuruşu 'Sivas'ın yıllık geliri bu meblağı karşılamaz' diyerek ödemeyi reddetti; TDV İslâm Ansiklopedisi'ne göre isyanının gerekçesi padişahın rahatsızlığı yüzünden devlet işlerinin kadınların eline geçtiği ve bunun sık vali değişiklikleriyle istikrarsızlık doğurduğu iddiasıydı. Mayıs 1648'de önce askerî başarı kazandıysa da İpşir Mustafa Paşa karşısında yenildi, 20 Mayıs 1648'de idam edilip başı İstanbul'a gönderildi.",
  kaynak:"varvar-ali-pasa" },

// ---------- Kemankeş Kara Mustafa Paşa ----------
{ t:"1638-12-24", b:"Kemankeş Kara Mustafa Paşa sadrazam oldu — mali ıslahat dönemi başladı", tur:"sadrazam",
  onem:3, dunya:1, kapsam:"ic", etiket:["siyaset","ekonomi","islahat"],
  yer_id:"İstanbul",
...
{ t:"1725-01-01", b:"Otuz iki kişilik ilim/tercüme heyeti kuruldu", tur:"kultur",
  ...
  yer_id:"İstanbul",
  d:"Damad İbrahim Paşa'nın sadâreti döneminde İstanbul'da, TDV'nin tabiriyle 'devrin akademisi sayılabilecek' otuz iki kişilik bir âlim-kâtip heyeti kuruldu. Heyet Arapça, Farsça, Yunanca ve Latince'den tarih, felsefe ve coğrafya eserlerini Türkçeye kazandırdı — Yanyalı Esad Efendi'nin yirmi beş kişilik ekiple Aristo'nun Fizik'ini çevirmesi ve şair Nedim'in bir tarih çevirisi heyetine başkanlık etmesi bunlar arasındaydı. Gün TDV'de belirtilmiyor, yıl beyan.",
  kaynak:"damad-ibrahim-pasa-nevsehirli" },

// ---------- Patrona Halil sonrası ----------
{ t:"1730-11-25", b:"I. Mahmud, Patrona Halil'i saraya davet ederek tuzağa düşürdü", tur:"darbe",
  onem:4, dunya:2, kapsam:"ic", etiket:["siyaset","darbe-askeri","suikast"],
  yer_id:"İstanbul",
  d:"Tahta çıkışından yedi hafta sonra I. Mahmud, güvendiği adamları — sarayda Hacı Beşir Ağa, dışarıda Kırım Hanı I. Kaplan Giray — aracılığıyla asker ileri gelenlerini kendi safına çekip Patrona Halil'in nüfuzunu kırdı. 25 Kasım 1730'da Topkapı Sarayı'nda Sünnet Odası'ndaki bir toplantıya çağrılan Patrona Halil, Muslu Beşe ve Kel Mehmed Ağa içeri alındı; Sadrazam Silâhdar Mehmed Paşa'nın işaretiyle önceden gizlenmiş otuz iki silahlı adam ortaya çıkıp üçünü de öldürdü. I. Mahmud böylece isyanın kontrolünü tamamen ele geçirdi.",
  kaynak:"patrona-isyani + mahmud-i--osmanli" },

// ---------- Humbaracı Ahmed Paşa ----------
{ t:"1731-01-01", b:"Humbaracı Ahmed Paşa (Bonneval) Humbaracı Ocağı'nın başına getirildi", tur:"magazin",
  onem:3, dunya:2, kapsam:"ic", etiket:["askeri","reform","magazin"],
  yer_id:"İstanbul",
  d:"Asıl adı Claude-Alexandre Comte de Bonneval olan Fransız asıllı subay, önce Fransa ve Avusturya ordularında hizmet ettikten sonra Saraybosna'da İslâmiyet'i kabul ederek Ahmed adını aldı ve 1729'da Osmanlı Devleti'ne sığındı. I. Mahmud döneminde 1731'de Humbaracı Ocağı'nın başına getirilen Ahmed Paşa, Üsküdar Ayazma'da kurdurduğu kışlada Bosna'dan getirtilen 300 kadar nefere talim yaptırdı; sayıları kısa sürede 600'ü aştı ve kendisi matematik dersleri de verdi. Fransa lehine Macaristan'da Rákóczi ile giriştiği ayaklanma teşebbüsü nüfuzunu sarstı ve 1738'de Kastamonu'ya sürüldü. 23 Mayıs 1747'de İstanbul'da öldü, mezarı Galata Mevlevîhânesi hazîresindedir.",
  kaynak:"humbaraci-ahmed-pasa" },

// ---------- I. Abdülhamid vefatı ----------
// ⚠️ NOT: bu madde 1789-04-07 için OLAYLAR_EK7 (satır 128) ile AYNI GÜNÜ
// paylaşıyor ("III. Selim tahta çıktı"). Mükerrer risk taşır — o kaydın
...
{ t:"1789-04-07", b:"I. Abdülhamid Özi'nin düşüş haberini okurken felç geçirip öldü", tur:"vefat",
  onem:4, dunya:2, kapsam:"ic", etiket:["siyaset","vefat","serhat"],
  yer_id:"İstanbul",
  ...
  kaynak:"abdulhamid-i", vefat_id:"abdulhamid1" },

// ---------- YIĞIN GÜNÜ MADDELERİ — M-1363/M-1366, koşuyu bekleten öncelik ----------
// 107 yerleşimin YYYY-01-01'de kümelenmiş kırılmalarını her biri kendi
// tarihsel epizoduna bağlar. Bazı yerleşimler TDV'ye göre farklı tarihe
...
{ t:"1557-01-01", k:"kurulus", etiket:["toprak-kazanc","diplomasi"],
  b:"Habeş Eyaleti'nin kuruluşu — Kızıldeniz kıyısının Osmanlı idaresine girişi",
...
{ t:"1738-08-01", k:"fetih", etiket:["toprak-kazanc","savas"],
  ...
  kisiler:"I. Mahmud",
  d:"TDV'nin Semendire maddesine göre 1717'de Pasarofça'yla Avusturya'ya bırakılan kale, 1737'de başlayan Osmanlı-Avusturya Savaşı'nın Tuna-Sava cephesindeki Osmanlı ilerleyişiyle geri alındı; Avusturya kuvvetleri bölgede Ağustos 1738'e kadar tutunabildi, bu tarihten sonra Semendire yeniden Osmanlı idaresine girdi. Bir yıl sonra imzalanan Belgrad Antlaşması (1739-09-18) bu kazancı — Belgrad ve kuzey Sırbistan ile birlikte — tescil edecekti. ⚠️ Aynı gün Kırım'da gerçekleşen 'Özi'nin geri alınışı' maddesiyle KARIŞTIRILMASIN — 1000 km uzakta, ayrı cephe, ayrı olay; yalnızca tarih rastlantısal olarak örtüşüyor.",
  kaynak:"semendire", duygu:["🎉"] },

{ t:"1815-11-05", k:"antlasma", etiket:["antlasma","diplomasi"],
  b:"Ayamavra ve İyon Adaları'nın İngiliz himayesine geçişi — Napolyon sonrası düzen",
  gun:"5 Kasım 1815",
  yer:"Ayamavra (Lefkada)", yer_id:"Ayamavra (Lefkada)",
  kisiler:"Robert Stewart (Castlereagh), Klemens von Metternich",
  d:"⚠️ TDV bu maddeyi kapsamıyor — Napolyon sonrası İyon Adaları meselesi Osmanlı'nın artık taraf olmadığı bir Avrupa iç düzenlemesidir; dayanak standart akademik kaynak (Encyclopaedia Britannica, 'Treaty of Paris'). 1797'de Fransa'ya geçen Ayamavra ve öteki İyon adaları, Napolyon'un kesin yenilgisinin ardından 5 Kasım 1815'te Paris'te İngiltere, Rusya, Avusturya ve Prusya arasında imzalanan özel antlaşmayla 'Yedi Ada Birleşik Devletleri' adı altında İngiliz himayesine bırakıldı — bu, 20 Kasım 1815'teki genel Paris Antlaşması'ndan AYRI bir belgedir. Himaye 1864'e kadar sürecek, sonra adalar Yunanistan'a devredilecekti.",
  kaynak:"bulunamadı — TDV bu dönemi/bölgeyi kapsamıyor, dayanak: Encyclopaedia Britannica 'Treaty of Paris (1815)'", duygu:["🏴"] },

{ t:"1688-01-17", k:"kayip", etiket:["toprak-kayip","savas"],
  b:"Munkács (Mukacheve) kalesinin üç yıllık kuşatma sonrası Avusturya'ya teslimi",
  gun:"17 Ocak 1688 — DÜZELTİLMİŞ TARİH, bkz. not",
  yer:"Munkács (Mukacheve)", yer_id:"Munkács (Mukacheve)",
