...
//   FAZ 2 ③④ · NEHİR SÜRTÜNME · 6 Eylül 2026. Model: işgal `isg:` ÖRTÜSÜ, alt katman DEVAM EDER (koordinatör kararı). Her kayıt ALT KATMAN KESİNTİSİZLİK sınavından geçti; geçmeyen yamaya GİRMEDİ.
// ═══════════════════════════════════════════════════════════════════
window.YER_YAMA_CUKUROVA_ISG_0907 = [
  {
    "ad": "Adana",
    "d": [
      {
    ...
    "isg": [
      {
        ...
        "t": "1921-10-20",
        "d": "fransa-cumhuriyet",
        "kaynak": "bulunamadı — TDV'de müstakil madde YOK (302) ve kapsayıcı maddeler (adana · tarsus · osmaniye · sanliurfa) bu yerleşimi işgal bağlamında ANMIYOR; gün mevcut veriden devralındı, KAYNAKSIZ"
      }
    ]
  },
  {
    ...
    "isg": [
      {
        ...
        "t": "1919-10-29",
        "d": "ingiltere",
        "kaynak": "TDV `kahramanmaras` — kaynaklı"
      },
      {
        "f": "1919-10-29",
        "t": "1920-02-11",
    ...
    "isg": [
      {
        ...
        "t": "1921-10-20",
        "d": "fransa-cumhuriyet",
        "kaynak": "TDV `nusaybin` — veriden devralındı — kaynaksız"
      }
    ]
  },
  {
    ...
    "isg": [
      {
        ...
        "t": "1919-10-29",
        "d": "ingiltere",
        "kaynak": "TDV `sanliurfa` — AY hassasiyeti: TDV 'Mart 1919'"
      },
      {
        "f": "1919-10-29",
        "t": "1920-04-10",
        "d": "fransa-cumhuriyet",
        "kaynak": "TDV `sanliurfa` — TÜRETİLDİ — doğrulanmadı"
      }
    ]
  },
  {
