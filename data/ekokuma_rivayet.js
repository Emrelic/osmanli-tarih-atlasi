...
{ id:"sebep-sonuc-1594-uc-voyvodalik-isyani", tur:"sebep-sonuc",
  ...
  bag:"Önemi: bu üçlü ittifak, aynı yıllarda süren Uzun Harp'in kuzey/Tuna cephesini açtı ve Osmanlı'yı aynı anda iki cephede (Avusturya'ya karşı Macaristan'da, voyvodalıklara karşı Tuna'nın kuzeyinde) savaşmak zorunda bıraktı. Bu isyanın kronolojide kendi maddesi yoktu — `olaylar_ek10.js` bu boşluğu 1593-1596 arası için zaten ÖLÇMÜŞTÜ ama hiçbir oturum yazmamıştı; bu turda `data/olaylar_p0059.js`e yazıldı.",
...
{ id:"sebep-sonuc-tunus-huseyniler-1705", tur:"sebep-sonuc",
  ...
  bag:"H-0008'in sorusu tam burada cevap buluyor: 'Tunus'ta daha önce Osmanlı'nın atadığı valiler etkili değil miydi?' Cevap: 1705'ten ÇOK ÖNCE değillerdi. Tunus 1574'te Osmanlı'ya katılıp `sâlyâneli eyalet` sistemine girdiğinden (bkz. `statu-garp-ocaklari-cezayir`, `data/ekokuma_statu.js`) beri, gerçek yürütme gücü zaten yerel askerî-idarî makamlardaydı — önce dayılar, sonra (1613'ten itibaren) Murâdî beyleri hânedanı. 1705'te DEĞİŞEN şey 'yerel özerklik başladı' değil, 'hangi yerel hanedanın özerkliği elinde tuttuğu'ydu (Murâdîler'den Hüseynîler'e). İstanbul'un rolü hiçbir zaman fiilen valiler atayıp yönetmek değildi — hutbenin padişah adına okunması, sikkenin (parası) onun adına basılması ve düzenli fermanlarla biatın periyodik olarak tazelenmesiyle sınırlı sembolik bir üst egemenlikti; vergi miktarı bile İstanbul'la PAZARLIK konusuydu.",
