...
{ id:"tartisma-kadinlar-saltanati", tur:"tartisma",
  ...
  metin:"16. yüzyıl sonu ile 17. yüzyıl ortası arasındaki, vâlide sultanların ve haseki sultanların devlet işlerinde belirgin biçimde etkili olduğu döneme bu adı, tarihçi Ahmed Refik Altınay'ın 1916'da yayımladığı \"Kadınlar Saltanatı\" adlı kitabı verdi. Terim, yayımlandığı dönemin imparatorluğu bir \"duraklama ve gerileme\" çizgisinde okuyan tarihyazımı içinde doğdu ve dönemi kadınların ve haremin devlet yönetimine karışması olarak, yani olumsuz bir çerçevede adlandırdı. TDV'nin 'Vâlide Sultan' maddesi de vâlide sultanların devlet işlerine doğrudan karıştığı XVI. yüzyılın son çeyreği ile XVII. yüzyıl ortası arasını bu adla anar ve dönemin 1656'da Turhan Sultan'ın gücü Köprülü Mehmed Paşa'ya devretmesiyle kapandığını yazar. Sonraki akademik çalışmalar bu adlandırmanın kendisini sorgulamaya başladı; bu alanda en sık anılan çalışmalardan biri Leslie Peirce'in \"The Imperial Harem: Women and Sovereignty in the Ottoman Empire\" (Oxford University Press, 1993) adlı kitabıdır. Bugün bu literatürde tartışılan soru yalnız \"kadınlar gerçekten yönetti mi\" değil, \"bu dönem niçin ve kimin gözünden bu adı aldı\" sorusudur. Olgunun kendisinin, yani kadınların ne ölçüde yönettiğinin tartışması bu kartın değil, 'Merak' bölümündeki \"Kadınlar Saltanatı\" kartının konusudur. Bu ayrım bugün de önemli: terim popüler kullanımda tarafsız bir dönem adı gibi geçse de, kökeninde 20. yüzyıl başının eleştirel bir bakış açısı vardır.",
  bag:"Bu kart yalnız terimin tarihini anlatır. Dönemin gerçekten bir yönetim biçimi olup olmadığına dair üç görüş için 'Merak' bölümündeki \"Kadınlar Saltanatı\" kartına bakın.",
  ic_not:"(PAKET-EK1, 13 Eyl 2026, parti 0048 H-0003) Okuyucuya görünen `not` alanı KALDIRILDI; üretim notu buraya taşındı. ESKİ `not`: \"Peirce'in kitabının tam metni okunmadı (erişim yok); burada aktarılan, birden çok bağımsız akademik özetin/tanıtımın YAKINSADIĞI bir konsensüstür — D107 gereği 'okumadım' diye ayrıca damgalanır.\" DURUM: kitap hâlâ OKUNMADI. Bu yüzden metin, Peirce'in kitabının İÇERİĞİNE dair iddialardan arındırıldı ('terimi sorguladı ve … sormayı öğretti' cümlesi çıkarıldı); kitap yalnız 'alanda sık anılan çalışmalardan biri' diye bibliyografik olarak anılıyor. 'TDV Vâlide Sultan maddesi bu adlandırmayı aktarır' cümlesi bu turda TDV valide-sultan gövdesinde ÖLÇÜLDÜ ve DOĞRU çıktı (gövde: '“kadınlar saltanatı” denilen dönemdir' · 1656'da 'kadınlar saltanatı sona ermiş oldu'); cümle kaynağın söylediği biçimde yeniden yazıldı. ESKİ `bag` bir dosya adı ve kimlik taşıyordu (merak.js kadinlar-saltanati); okuyucu diliyle yeniden yazıldı.",
  kesinlik:"tartismali",
  olay:["1595-02-01","1651-09-02"],
