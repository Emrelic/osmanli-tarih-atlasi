...
window.KADEME_YAMA = [
  ...
  {ad:"Bistâm", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: bistam 302 · KAPSAYICI: simnan VE horasan — IKISINDE DE ad + idari terim tasiyan cumle YOK"},
  {ad:"Senendec (Sine)", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: senendec · sine · erdelan 302 · KAPSAYICI: kirmansah — ad + idari terim YOK. ⚠️ `kurdistan` slug'i 2224 bayt dondu, BOILERPLATE'e yakin: o adres icin dogru hukum 'CEKILEMEDI', 'yok' DEGIL"},
  {ad:"Sokotra", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: sokotra · sukutra 302 · KAPSAYICI: yemen (117 KB) VE hadramut (24 KB) — IKISINDE DE ad + idari terim tasiyan cumle YOK"},
  ...
  {ad:"Adua", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: etiyopya · eritre · habes-eyaleti — UCUNDE DE idari baglamda 0"},
  {ad:"Mekelle", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: etiyopya · eritre · habes-eyaleti — UCUNDE DE idari baglamda 0"},
  {ad:"Lalibela", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: etiyopya · eritre · habes-eyaleti — UCUNDE DE idari baglamda 0"},
  {ad:"Sokota", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: etiyopya · eritre · habes-eyaleti — UCUNDE DE idari baglamda 0"},
  {ad:"Adigrat", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: etiyopya · eritre · habes-eyaleti — UCUNDE DE idari baglamda 0"},
  {ad:"Vukro", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: etiyopya · eritre · habes-eyaleti — UCUNDE DE idari baglamda 0"},
  {ad:"Alamata", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: etiyopya · eritre · habes-eyaleti — UCUNDE DE idari baglamda 0"},
  {ad:"Debârek", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: etiyopya · eritre · habes-eyaleti — UCUNDE DE idari baglamda 0"},
  {ad:"Metemma", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: etiyopya · eritre · habes-eyaleti — UCUNDE DE idari baglamda 0"},
  {ad:"Şire", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: etiyopya · eritre · habes-eyaleti — UCUNDE DE idari baglamda 0. ⚠️ 'Sire' kisa ve yaygin bir dize; gevsek esleme SAHTE POZITIF veriyor (sira·sure·seri) — bu hukum SIKI eslemeyle ve cumle OKUNARAK verildi"},
  {ad:"Adi Kayh", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: etiyopya · eritre · habes-eyaleti — UCUNDE DE idari baglamda 0"},
  {ad:"Adi Kuala", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: etiyopya · eritre · habes-eyaleti — UCUNDE DE idari baglamda 0"},
  {ad:"Barentu", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: etiyopya · eritre · habes-eyaleti — UCUNDE DE idari baglamda 0"},
  {ad:"Tesseney", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: etiyopya · eritre · habes-eyaleti — UCUNDE DE idari baglamda 0"},
  {ad:"Nakfa", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: etiyopya · eritre · habes-eyaleti — UCUNDE DE idari baglamda 0"},
  {ad:"Zula", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: etiyopya · eritre · habes-eyaleti — UCUNDE DE idari baglamda 0"},
  {ad:"Salala", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: uman — ad GECIYOR ('diger onemli sehirleri ... SALALE') ama bu MODERN bir onemli-sehir listesi, MERTEBE beyani DEGIL"},
  {ad:"Suhâr", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: uman — ad GECIYOR ('diger onemli sehirleri ... SUHAR') ama MODERN onemli-sehir listesi, MERTEBE beyani DEGIL"},
  {ad:"Sûr", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: uman — yalniz universite listesinde ('Zafar, Macan, SUR, Nizva ve Suhar universiteleri'), MERTEBE beyani YOK"},
  {ad:"Tâka (Zufâr)", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: uman — 'Zafar' bir MUHAFAZA olarak geciyor AMA o BOLGENIN adi; noktamiz TAKA kasabasi. Bolgenin mertebesini kasabaya atamak YANLIS olurdu (Zagem/'Zegem Arani' vakasinin aynisi)"},
  {ad:"Mirbât", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: uman — 0 KEZ"},
  {ad:"Dukm", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: uman — 0 KEZ"},
  {ad:"Masira", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: uman — 0 KEZ (⚠️ gevsek esleme 'Misir'a' ile SAHTE POZITIF veriyor; siki eslemeyle olculdu)"},
  {ad:"Muhût", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: uman — 0 KEZ"},
  {ad:"Hâsik", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: uman — 0 KEZ"},
  {ad:"Cezîr (Sevkıra)", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: uman — 0 KEZ"},
  {ad:"Şüveymiye", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: uman — 0 KEZ"},
  {ad:"Tumreyt", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: uman — 0 KEZ"},
  {ad:"Rahbût", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: uman — 0 KEZ"},
  {ad:"Râs Medreke", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: uman — 0 KEZ"},
  {ad:"Mukalla", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: mukalla 302 · KAPSAYICI: hadramut (24 KB) — idari terim + siralama tasiyan cumle YOK; yemen maddesinde de MERTEBE beyani yok"},
  {ad:"Ebîverd", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: horasan VE turkmenistan — ad `horasan`da GECIYOR ama IKTISADI baglamda ('Nisabur, Nesa, EBIVERD, Tus, Herat, Merv her turlu dokuma ve ipek uretiminin merkeziydi'); bir URETIM merkezi beyani IDARI mertebe beyani DEGILDIR"},
  {ad:"Nesâ", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: horasan VE turkmenistan — ad `horasan`da GECIYOR ama ayni IKTISADI cumlede; idari mertebe YOK"},
  {ad:"Tûs", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: horasan VE meshed — ad `horasan`da ayni IKTISADI cumlede geciyor; `meshed` (6 KB) maddesinde idari terimle GECMIYOR"},
  {ad:"Serahs", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: horasan (52 KB) VE turkmenistan (61 KB) — IKISINDE DE ad + idari terim tasiyan cumle YOK"},
  {ad:"Türkistan (Yesi)", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: turkistan (28 KB) · yesevi · hokand — UCUNDE DE ad + idari terim tasiyan cumle YOK"},
  {ad:"Kelât-ı Nâdirî", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: horasan — YOK. ⚠️ `nadir-sah` slug'i 1233 bayt dondu = BOILERPLATE; o adres icin dogru hukum 'CEKILEMEDI', 'yok' DEGIL"},
  {ad:"Aşkabad", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: turkmenistan — ad GECIYOR ve MERTEBE DE VAR ('BASSEHIR Askabad') AMA cumle 1948 depremi baglaminda ve Askabad 1924'te Turkmen SSC basshehri oldu; atlas 1923'te bitiyor ⇒ MENZIL DISI (Karaci ile ayni cins)"},
  {ad:"Halhâl", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: zencan VE azerbaycan — IKISINDE DE 0"},
  {ad:"Bîcâr", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: zencan — 0. ⚠️ `kurdistan` slug'i 2224 bayt = BOILERPLATE'e yakin; o adres icin dogru hukum 'CEKILEMEDI'"},
  {ad:"Sakkız", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: azerbaycan — 0. ⚠️ `kurdistan` BOILERPLATE'e yakin (2224 bayt), 'cekilemedi'"},
  {ad:"Merîvan", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: azerbaycan — 0. ⚠️ `kurdistan` BOILERPLATE'e yakin (2224 bayt), 'cekilemedi'"},
  {ad:"Mîyandoab", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: urmiye VE azerbaycan — IKISINDE DE 0"},
  {ad:"Nâin", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: isfahan (47 KB) — 0"},
  {ad:"Erdistan", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: isfahan (47 KB) — 0"},
  {ad:"Gulpâygân", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: isfahan (47 KB) — 0"},
  {ad:"Lâhîcan", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: gilan — 0"},
  {ad:"Bender Enzeli", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: gilan — 0"},
  {ad:"Astara", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: gilan VE azerbaycan — IKISINDE DE 0"},
  {ad:"Ferahâbâd", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: taberistan — 0"},
  {ad:"Eşref (Behşehr)", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: taberistan — 0"},
  {ad:"Kâşân", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: kasan CANLI ama IDARI mertebe VERMIYOR: 'Kasan bir EL SANATLARI merkezi olmustur ... halı, kadife ve ipekli kumas dokumaciligi' — IKTISADI beyan (Ebiverd/Nesa/Tus ile ayni cins). KAPSAYICI: isfahan — 0"},
  {ad:"Esterâbâd (Gürgân)", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: taberistan — ad GECIYOR ama mertebe YOK: 'sehzadelerin baslica KISLIK MERKEZLERINDEN biri' bir SARAY varligidir, IDARI mertebe degil ('atlas seferi degil TASARRUFU boyar' dersinin kisla yuzu). KAPSAYICI: horasan — 0"},
  {ad:"Yeni Ürgenç", kaynak:"bulunamadi", neden:"kaynak susuyor — TDV'de madde ARANDI, yok. Denenen sluglar: KAPSAYICI: hive-hanligi VE harizm — 'Urgenc' GECIYOR ve idari beyan da VAR ('Urgenc'in MERKEZ durumunda bulundugunu' · 'Arap Mehmed Han Urgenc'i terkedip Hive'yi basshehir yapti'). 🔴 AMA bu atiflarin HEPSI 1603-1622 ve oncesi; YENI Urgenc veride kur:1646, yani HENUZ KURULMAMISTI. Atiflar KOHNE Urgenc'e ait ve oraya yazildi. Yeni Urgenc icin kaynak SUSUYOR"},
];
