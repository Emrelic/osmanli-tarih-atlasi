# KADEME-AVRUPA — KADEME + kd:, bölge: BATI + ORTA AVRUPA
...
```
BATI + ORTA AVRUPA
lat 36..71 / lon -12..32 — 393 kademesiz nokta. 🔴 TDV kapsaması BATI AVRUPA'DA %0 (ölçüldü: İskoçya · İrlanda · Lüksemburg · Bretanya · Burgonya TDV'de gerçekten YOK). Akademik kaynak meşrudur ve `kaynak:` alanına AÇIKÇA yazılır.
```
...
`"BATI + ORTA AVRUPA kutusunda N kademesiz nokta vardı → M'sine kademe yazıldı,
