# İZ-YOK DENETİM A — "çözüldü" diyen ama kanıtı olmayan maddeler

```
AD      İŞÇİ-0910-A  →  yeni adın: İZ-YOK DENETİM A
...
🟢 YAZABİLİRSİN — ve YALNIZ bunlar:
   oturumlar/IZ-YOK-DENETIM-A.md          ← bu dosya, ilerlemeni buraya yaz
   denetim/IZYOK-A-<ne>-0910.md           ← bulgu raporların
   denetim/ARAC-IZYOK-A-<ne>-0910.py      ← yazarsan aletlerin
...
adların `IZYOK-A-` önekiyle başlasın — `git add` ile kendi dosyalarını
...
```
GİRDİ    89 madde (DİLİM 1) — aşağıda paket paket yazılı
ÇIKTI    89 maddenin 89'u DÖRT KOVADAN birine düşmüş olacak:
...
BİTİŞ    89 = 🟢+🔴+⚪+➖   ve her satırda DAYANAK yazılı
```

🔴 **"Bitirdim" TESLİM DEĞİL.** Teslim: *"89 → 🟢 N · 🔴 M · ⚪ K · ➖ L"*.
...
207  iz-yok                   🟢 ÖLÇÜLDÜ bugün · aynı alet
 89  senin dilimin            🟢 ÖLÇÜLDÜ bugün · paket paket sayıldı
...
### Senin dilimin — DİLİM 1, 89 madde / 14 paket

```
parti-0002(4)  0003(6)  0004(6)  0006(16) 0007(6)  0008(11) 0010(1)
parti-0012(1)  0013(1)  0014(3)  0015(3)  0017(3)  0018(2)  0019(26)
```
Paket adları: `0002`-`0007` → `parti-000X` · `0008`+ → `parti-emrelic-00XX`
Kutu kökü: `C:\Users\emrem\OneDrive\Desktop\ClaudEmre\kutu\giden`

🟢 **SIRAYI SEN SEÇ** — ama **0019(26)** ve **0006(16)** en kalabalık ikisi;
ikisinden birinde bir DESEN çıkarsa kalanı hızlanır.
...
gereksiz. Açık kalemleri sana ben söylüyorum: **senin açık kalemin bu 89
...
```
② AÇILIŞ    "aldım, DİLİM 1 bende, başlıyorum"     ← ŞİMDİ
③ GİDİŞAT   her paket bitince tek satır: "0006: 16 → 🟢9 🔴4 ⚪3"
