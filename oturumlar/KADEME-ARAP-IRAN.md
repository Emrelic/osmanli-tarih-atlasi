# KADEME-ARAP-IRAN — KADEME + kd:, bölge: ARAP DÜNYASI + İRAN + KAFKASYA
...
```
ARAP DÜNYASI + İRAN + KAFKASYA
lat 12-45 / lon 25-70 — TDV kapsaması %86-100. Mısır · Şam · Bağdat · Basra · Yemen eyaletleri, İran şehirleri.
```
...
`"ARAP DÜNYASI + İRAN + KAFKASYA kutusunda N kademesiz nokta vardı → M'sine kademe yazıldı,
