# KADEME-DUNYA — KADEME + kd:, bölge: KALAN DÜNYA
...
```
KALAN DÜNYA
yukarıdaki iki kutunun DIŞI — Avrupa · Afrika · Asya · Amerika. TDV kapsaması düşük; akademik kaynak ve `bulunamadı` çok olacak, ve bu bir BAŞARISIZLIK DEĞİL.
```
...
`"KALAN DÜNYA kutusunda N kademesiz nokta vardı → M'sine kademe yazıldı,
