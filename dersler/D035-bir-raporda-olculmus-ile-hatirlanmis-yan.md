# BİR RAPORDA ÖLÇÜLMÜŞ İLE HATIRLANMIŞ YAN YANA DURURSA, OKUYAN İKİSİNİ DE ÖLÇÜLMÜŞ SANAR — VE YAZAN DA.

> Kimlik `D035` · `CLAUDE.md §11` dizininden taşındı (10 Eylül 2026 budaması).
