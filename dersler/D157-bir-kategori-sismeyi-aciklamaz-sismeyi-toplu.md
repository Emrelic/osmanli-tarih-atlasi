# BİR KATEGORİ ŞİŞMEYİ AÇIKLAMAZ — ŞİŞMEYİ *TOPLU ATAMA* AÇIKLAR, ve ikisi karıştırılırsa çare yanlış yere gider.

> Kimlik `D157` · `CLAUDE.md §11` dizininden taşındı (10 Eylül 2026 budaması).
