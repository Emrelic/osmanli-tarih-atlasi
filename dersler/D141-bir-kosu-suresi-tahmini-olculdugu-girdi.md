# BİR KOŞU SÜRESİ TAHMİNİ, ÖLÇÜLDÜĞÜ GİRDİ BÜYÜKLÜĞÜYLE BİRLİKTE TAŞINIR — ve fırlatıcının kendi kaydı bir TAHMİNDEN iyidir ama TABANSIZ okunursa yanıltır.

> Kimlik `D141` · `CLAUDE.md §11` dizininden taşındı (10 Eylül 2026 budaması).
