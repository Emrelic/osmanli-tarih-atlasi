# BİR YER ADI GÖVDEDE GEÇEBİLİR VE GÖVDE ONU KAPSAMIYOR OLABİLİR — SINIR olarak geçmiştir.

> Kimlik `D078` · `CLAUDE.md §11` dizininden taşındı (10 Eylül 2026 budaması).
