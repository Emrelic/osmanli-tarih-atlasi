# BİR SAYIM BİRİMİ YANLIŞSA, ÖLÇÜM VERİYİ DEĞİL VERİNİN YAPISINI ÖLÇER — ve gecenin üç bulgusu da bu tek kökten çıktı.

> Kimlik `D156` · `CLAUDE.md §11` dizininden taşındı (10 Eylül 2026 budaması).
