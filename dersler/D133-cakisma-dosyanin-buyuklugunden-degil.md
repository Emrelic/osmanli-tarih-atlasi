# ÇAKIŞMA, DOSYANIN BÜYÜKLÜĞÜNDEN DEĞİL, BAŞKALARININ ZATEN YAZDIĞI TOPRAĞA DOKUNMASINDAN DOĞAR.

> Kimlik `D133` · `CLAUDE.md §11` dizininden taşındı (10 Eylül 2026 budaması).
