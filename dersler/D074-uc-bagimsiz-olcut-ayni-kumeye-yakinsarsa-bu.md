# ÜÇ BAĞIMSIZ ÖLÇÜT AYNI KÜMEYE YAKINSARSA, BU KÜMENİN *TAM* OLDUĞUNUN KANITIDIR — *DOĞRU* OLDUĞUNUN DEĞİL.

> Kimlik `D074` · `CLAUDE.md §11` dizininden taşındı (10 Eylül 2026 budaması).
