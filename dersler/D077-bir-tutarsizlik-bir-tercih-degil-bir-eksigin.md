# BİR TUTARSIZLIK BİR TERCİH DEĞİL, BİR EKSİĞİN SONUCU OLABİLİR — ve o zaman "hangisi doğru" SORUSU YANLIŞTIR.

> Kimlik `D077` · `CLAUDE.md §11` dizininden taşındı (10 Eylül 2026 budaması).
