# BİR EŞİK, ÖLÇÜLDÜĞÜ TABANLA BİRLİKTE TAŞINIR — taban değişince eşik geçersizleşir ve YENİDEN TÜRETİLMEDEN kullanılamaz.

> Kimlik `D129` · `CLAUDE.md §11` dizininden taşındı (10 Eylül 2026 budaması).
