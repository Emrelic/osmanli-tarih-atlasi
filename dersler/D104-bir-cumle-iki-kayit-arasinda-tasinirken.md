# BİR CÜMLE İKİ KAYIT ARASINDA TAŞINIRKEN KAYNAĞINI DA TAŞIR — yoksa hakemli bir kaydın içine adsız bir iddia girer.

> Kimlik `D104` · `CLAUDE.md §11` dizininden taşındı (10 Eylül 2026 budaması).
