# AYNI DAMGA, FARKLI DAYANAK GÜCÜ — damga GÖRÜNÜR kılar, ama NE KADAR SAĞLAM olduğunu KAYDETMEZ.

> Kimlik `D075` · `CLAUDE.md §11` dizininden taşındı (10 Eylül 2026 budaması).
