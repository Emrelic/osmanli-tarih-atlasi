// denetim/SINIR-ARABISTAN-0078-govde.js — Arabistan kutusundaki (SINIR-UZAKDOGU-0078 kopyası, yalnız KUTU değişti) petek
// gövdelerini (data/devletler_harita.js, js/app.js ile AYNI çözümleme) GeoJSON'a döker.
// Kullanım: node denetim/SINIR-ARABISTAN-0078-govde.js <çıktı.geojson> [gün]
// Tüketicisi: denetim/SINIR-ARABISTAN-0078-serit.py (şerit ölçümü, §5.4).
"use strict";
const fs = require("fs"), vm = require("vm"), path = require("path");
const KOK = path.join(__dirname, "..");
const cikti = process.argv[2], gunS = process.argv[3] || "1923-09-01";
const KUTU = [33, 11, 61, 34];
