# -*- coding: utf-8 -*-
"""BASRA-KORFEZ · TDV madde govdesi cekici (17 Eylul 2026).

Kullanim:  py denetim/ARAC-BASRA-GOVDE-0917.py <slug> [<slug> ...]
Cikti:     denetim/_govde_basra/<slug>.txt   (duz metin)
...
CIKTI = os.path.join(KOK, "_govde_basra")
