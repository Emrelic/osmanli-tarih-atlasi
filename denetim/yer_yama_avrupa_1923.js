...
window.YER_YAMA_AVRUPA_1923 = [
  ...
  { ad:"Elba",
    ...
    kaynak:"Treccani, Enciclopedia Italiana, 'Piombino' — 1548 GEÇİCİ işgal ('...di occupare, SIA PURE TEMPORANEAMENTE, Piombino'), 1557 iade ('SOLO NEL 1557 ... Cosimo si decise a renderlo a Iacopo VI'), 1805 Elisa Bonaparte, 1815 Viyana Kongresi Nihai Senedi ile Toskana'ya birleştirme ('Caduto Napoleone, con l'atto finale del congresso di Vienna, Piombino fu unita alla Toscana'). TDV kapsam dışı — 'piza' slug 302 ölü, Batı Avrupa TDV kapsamı %0 (§4). Britannica 'Elba' HTTP 403 ⇒ ÖLÇÜLEMEDİ, 'kaynak yok' DEĞİL. 🔴 §②b DAMGASI: bu kaynak OLAYIN dayanağıdır, GÜNÜN DEĞİL — Treccani 'con l'atto finale del congresso di Vienna' diyor ve YIL veriyor (1815), gün VERMİYOR. `1815-06-09` günü atlasın KENDİ çekirdeğinden devralındı (aynı gün, 0 gün uzaklıkta, 'Viyana Kongresi Nihai Senedi' maddesi) ve 36 kayıt onu kullanıyor. GÜNÜN kaynaktan dayanağı ÖLÇÜLEMEDİ." },

  { ad:"Dublin",
    s:[{f:"1281-01-01",t:"1922-12-06",d:"ingiltere"},
       {f:"1922-12-06",t:"1923-10-29",d:"irlanda-serbest-devlet"}
    ],
    kaynak:"RTÉ Century Ireland (İrlanda ulusal yayıncısının Boston College ortaklı akademik tarih projesi): 'The constitution of the Irish Free State became law on 6 December 1922.' İkinci bağımsız teyit: 6 Aralık 1922'de George V'in bildirisiyle Serbest Devlet kuruldu ve Dublin başkenti oldu. TDV kapsam dışı — Batı Avrupa TDV kapsamı %0 (§4). 🟢 §②b DAMGASI: bu kaynak GÜNÜN dayanağıdır — gövde günü AÇIKÇA veriyor ('on 6 December 1922') ve gövdesi ÇEKİLİP okundu, arama özetinden alınmadı." },
