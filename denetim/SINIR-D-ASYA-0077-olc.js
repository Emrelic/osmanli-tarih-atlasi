// SINIR-D-ASYA-0077 — hattın 5 km iki yanında doğru renk oranı (şartname §4.2).
...
//   window.__OLC = { aileler:["D_SINIRLAR_ASYA"], idler:null, gun:"1923-09-01", adim:10, ofset:5 };
//   eval(await fetch("denetim/SINIR-D-ASYA-0077-olc.js?"+Date.now()).then(r=>r.text()));
...
(function () {
  var A = window.__OLC || {};
  var aileler = A.aileler || ["D_SINIRLAR_ASYA"];
