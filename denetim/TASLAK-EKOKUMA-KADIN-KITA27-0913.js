...
{ id:"tartisma-kadinlar-saltanati", tur:"tartisma",
  ...
  metin:"16. yüzyıl sonu ile 17. yüzyıl ortası arasındaki, vâlide sultanların ve haseki sultanların devlet işlerinde belirgin biçimde etkili olduğu döneme bu adı, tarihçi Ahmed Refik Altınay'ın 1916'da yayımladığı \"Kadınlar Saltanatı\" adlı kitabı verdi. Ahmed Refik ve onu izleyen erken Cumhuriyet dönemi tarihyazımı bu dönemi imparatorluğun \"duraklama/gerileme\" anlatısı içinde bir sapma, kadınların ve haremin devlet yönetimine \"haksız\" bir müdahalesi olarak sundu — TDV'nin kendi \"Vâlide Sultan\" maddesi de bu adlandırmayı, döneme ve figürlere (özellikle Nurbanu, Safiye, Kösem ve Turhan Hatice) atıfla aktarır. 1990'larda tarihçi Leslie Peirce, \"The Imperial Harem: Women and Sovereignty in the Ottoman Empire\" (Oxford University Press, 1993) adlı çalışmasıyla bu anlatıyı akademik olarak sorguladı: Peirce'e göre kraliyet kadınlarının etkisi bir \"bozulma\" değil, hanedanın kendi siyasi yapısının — oğullarını iktidara hazırlama, gerektiğinde nâiplik yapma — doğal ve tasarlanmış bir sonucuydu; harem bir \"fesat yuvası\" değil, sarayın idari-siyasi bir kanadıydı. Bu tartışma bugün de sürüyor: terim popüler kullanımda yaygın olsa da, akademik literatür onu tarafsız bir dönem adı değil, tarihsel bir yargı içeren 19-20. yüzyıl icadı bir çerçeve olarak ele almayı tercih ediyor.",
  bag:"Bu, 'Merak' düğmesindeki data/merak.js id:kadinlar-saltanati kartının BENZERİ DEĞİL TAMAMLAYICISIDIR — o kart 'gerçek bir yönetim biçimi miydi'yi tartışır, bu kart TERİMİN KENDİSİNİN kim tarafından ve ne zaman icat edildiğini (Ahmed Refik, 1916) ve akademik itirazın adını (Peirce, 1993) verir.",
