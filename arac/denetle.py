...
BEKLENEN_ENKLAV_SORGU = 672  # 667→672: Silezya/Sudet A katmanı deliği kapatıldı (24 Eylül 2026, 8 nokta: Breslau · Liegnitz · Oppeln · Glatz · Gleiwitz · Kattowitz · Broumov · Jeseník). Yeni adaların TAMAMI A-koridor sınıfı ve ÖRNEKLEME ESERİ, hakiki enklav DEĞİL: "Broumov+Jeseník" ile "Kattowitz+Krakov" adaları, aradaki toprakta nokta OLMADIĞI için kopuk görünüyor (orta Polonya'da Łódź/Częstochowa/Kielce, Bohemya'da Hradec/Olomouc yok). Gerçek çare taban değil ARADAKİ NOKTALAR; taban o noktalar inince DÜŞÜRÜLECEK. · 666→667: Budin/Peşte 1527-29 Habsburg dönemi (TDV süleyman-i) Zapolya vasal adasını iki pencereye böldü, aynı ada iki kez sayılıyor (GEMINI-DOGRULA 19 Eyl) · 664→666: Diyarbakır TDV zinciri (1353 celâyirli · 1394 timurlu · 1401 akkoyunlu), KRONO-2S-3 19 Eyl — +2 A-koridor, kaynaklı düzeltme; komşu kayıtlar şehir düzeyinde kaynak bekliyor
